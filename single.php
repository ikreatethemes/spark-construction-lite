...
if(!$post_sidebar){
    $post_sidebar =  get_theme_mod( 'sparkconstructionlite_blog_single_template_sidebar','right' );
}

$single_post_elements = get_theme_mod('sparkconstructionlite_single_post_bottom_elements', array('pagination','comment','related_posts'));
