jQuery(document).ready(function ($) {
    ...
    function SparkConstructionLiteConvertHex(hexcolor, opacity) {
    ...
    function sparkconstructionlite_set_dynamic_css(control, style) {
     ...
     * Top Header Settings 
    */
    wp.customize('sparkconstructionlite_top_header_hide_show', function (value) {
        value.bind(function (to) {
            ...
            var sparkconstructionlite_top_bar = 'top-menu-bar ' + desk_visibility + ' ' + tab_visibility + ' ' + mob_visibility;
            $('.top-menu-bar').attr('class', sparkconstructionlite_top_bar);
        });
    });

    wp.customize('sparkconstructionlite_th_bg_color', function (value) {
    ...
    wp.customize('content_text_color', function (value) {
        value.bind(function (to) {
            var borderColor = SparkConstructionLiteConvertHex(to, 10);
            var lighterBorderColor = SparkConstructionLiteConvertHex(to, 5);
            ...
            sparkconstructionlite_set_dynamic_css('content_text_color', css);
        });
    });
     ...
     * Menu Style style 
    */
    wp.customize('sparkconstructionlite_header_full_nav_bg_color', function (value) {
        value.bind(function (to) {
            var css = '.nav-classic .nav-menu, .headertwo .nav-classic .nav-menu, .headerthree .nav-classic .nav-menu{background-color:' + to + '}';
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_header_full_nav_bg_color', css);
        });
    });

    /** Menu Item Color */
    wp.customize('sparkconstructionlite_menu_item_color', function (value) {
        value.bind(function (to) {
            ...
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_menu_item_color', css);
        });
    });

    wp.customize('sparkconstructionlite_menu_item_link_color', function (value) {
        value.bind(function (to) {
            ...
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_menu_item_link_color', css);
        });
    });

    wp.customize('sparkconstructionlite_menu_bg_color', function (value) {
        value.bind(function (to) {
            var css = '.hover-style1 .box-header-nav .main-menu .page_item.current_page_item>a, .hover-style1 .box-header-nav .main-menu .page_item:hover>a, .hover-style1 .box-header-nav .main-menu .page_item.focus>a, .hover-style1 .box-header-nav .main-menu>.menu-item.current-menu-item>a, .hover-style1 .box-header-nav .main-menu>.menu-item:hover>a, .hover-style1 .box-header-nav .main-menu>.menu-item.focus>a, .headertwo.hover-style1 .box-header-nav .main-menu .page_item.current_page_item>a, .headertwo.hover-style1 .box-header-nav .main-menu .page_item:hover>a, .headertwo.hover-style1 .box-header-nav .main-menu .page_item.focus>a, .headertwo.hover-style1 .box-header-nav .main-menu>.menu-item.current-menu-item>a, .headertwo.hover-style1 .box-header-nav .main-menu>.menu-item:hover>a, .headertwo.hover-style1 .box-header-nav .main-menu>.menu-item.focus>a, .headerthree.hover-style1 .box-header-nav .main-menu .page_item:hover>a, .headerthree.hover-style1 .box-header-nav .main-menu .page_item.focus>a, .headerthree.hover-style1 .box-header-nav .main-menu>.menu-item.current-menu-item>a, .headerthree.hover-style1 .box-header-nav .main-menu>.menu-item:hover>a, .headerthree.hover-style1 .box-header-nav .main-menu>.menu-item.focus>a{background-color:' + to + '}';
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_menu_bg_color', css);
        });
    });

    /** Sub Menu */
    wp.customize('sparkconstructionlite_submenu_bg_color', function (value) {
        value.bind(function (to) {
            var css = '.box-header-nav .main-menu .children, .box-header-nav .main-menu .sub-menu{background-color:' + to + '}';
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_submenu_bg_color', css);
        });
    });

    wp.customize('sparkconstructionlite_submenu_item_color', function (value) {
        value.bind(function (to) {
            var css = '.box-header-nav .main-menu .children>.page_item>a, .box-header-nav .main-menu .sub-menu>.menu-item>a{color:' + to + '}';
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_submenu_item_color', css);
        });
    });

    wp.customize('sparkconstructionlite_submenu_item_link_color', function (value) {
        value.bind(function (to) {
            ...
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_submenu_item_link_color', css);
        });
    });

    wp.customize('sparkconstructionlite_submenu_item_bg_color', function (value) {
        value.bind(function (to) {
            var css = '.nav-menu .main-menu .children li:hover>a, .nav-menu .main-menu .sub-menu li:hover>a{background-color:' + to + '}';
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_submenu_item_bg_color', css);
        });
    });

    /** Social Icon */
    wp.customize('sparkconstructionlite_social_icon_color', function (value) {
        value.bind(function (to) {
            var css = ".top-bar-menu ul.sparkconstructionlite-socialicon li a{ color:" + to + "}";
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_social_icon_color', css);
        })
    });

    wp.customize('sparkconstructionlite_social_icon_bg_color', function (value) {
        value.bind(function (to) {
            var css = ".top-bar-menu ul.sparkconstructionlite-socialicon li a{ background-color:" + to + "}";
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_social_icon_bg_color', css);
        })
    });

    wp.customize('sparkconstructionlite_social_icon_hover_color', function (value) {
        value.bind(function (to) {
            var css = ".top-bar-menu ul.sparkconstructionlite-socialicon li a:hover{ color:" + to + "; border-color:" + to + ";}";
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_social_icon_hover_color', css);
        })
    });

    wp.customize('sparkconstructionlite_social_icon_hover_bg_color', function (value) {
        value.bind(function (to) {
            var css = ".top-bar-menu ul.sparkconstructionlite-socialicon li a:hover{ background-color:" + to + "}";
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_social_icon_hover_bg_color', css);
        })
    });
     ...
     * Header Button 
    */
    wp.customize('sparkconstructionlite_hb_title', function (value) {
        value.bind(function (to) {
            $('.ikbutton-title').text(to);
        })
    });

    wp.customize('sparkconstructionlite_hb_text', function (value) {
        value.bind(function (to) {
            $('.ikbutton-text').text(to);
        })
    });

    wp.customize('sparkconstructionlite_hb_link', function (value) {
        value.bind(function (to) {
    ...
    wp.customize('sparkconstructionlite_header_button_bg_color', function (value) {
        value.bind(function (color) {
            $('.ikbutton-single-wrap').css('background-color', color);
        })
    });

    wp.customize('sparkconstructionlite_header_button_color', function (value) {
        value.bind(function (color) {
    ...
    wp.customize('sparkconstructionlite_enable_search', function (value) {
        value.bind(function (to) {
            if (to === 'enable') {
     ...
     * Breacrumbs Settings
    */
    wp.customize('sparkconstructionlite_show_title', function (value) {
        value.bind(function (to) {
            if( to ) {
    ...
    wp.customize('sparkconstructionlite_breadcrumb', function (value) {
        value.bind(function (to) {
            if( to ) {
    ...
    wp.customize('sparkconstructionlite_titlebar_title_align', function (value) {
        value.bind(function (to) {
    ...
    $.each(settingIds, function (i, settingId) {
        ...
        wp.customize('sparkconstructionlite_' + settingId + '_super_title', function (value) {
            value.bind(function (to) {
        ...
        wp.customize('sparkconstructionlite_' + settingId + '_title', function (value) {
            value.bind(function (to) {
        ...
        wp.customize('sparkconstructionlite_' + settingId + '_title_align', function (value) {
            value.bind(function (to) {
        ...
        wp.customize('sparkconstructionlite_' + settingId + '_title_style', function (value) {
            value.bind(function (to) {
                var sectionClass = '#' + settingId + '-section';
        ...
        wp.customize('sparkconstructionlite_' + settingId + '_bg_type', function (value) {
            value.bind(function (to) {
                ...
                if (to === 'none' || to === 'color-bg' || to === 'image-bg') {
                    ...
                    sparkconstructionlite_set_dynamic_css('sparkconstructionlite_' + settingId + 'none_setting', css);
                }
                if ('color-bg' === to) {
                    var color = wp.customize('sparkconstructionlite_' + settingId + '_bg_color').get();
                    
                    var css = sectionClass + '{background-color:' + color + '}';
                    css += sectionClass + '::before{ background-color: transparent }';
                    sparkconstructionlite_set_dynamic_css('sparkconstructionlite_' + settingId + '_bg_color', css);

                    var css = sectionClass + '{background-image:none}';
                    sparkconstructionlite_set_dynamic_css('sparkconstructionlite_' + settingId + '_bg_image_url', css);

                }
                if ('image-bg' === to) {
                    var image = wp.customize('sparkconstructionlite_' + settingId + '_bg_image_url').get();
                    var css = sectionClass + '{background-image:url(' + image + ')}';
                    css += sectionClass + '{ background-color: transparent }';
                    sparkconstructionlite_set_dynamic_css('sparkconstructionlite_' + settingId + '_bg_image_url', css);
                    var color_overlay = wp.customize('sparkconstructionlite_' + settingId + '_overlay_color').get();
                    var css = sectionClass + '::before{background-color:' + color_overlay + '}';
                    sparkconstructionlite_set_dynamic_css('sparkconstructionlite_' + settingId + '_overlay_color', css);
                }
            });
        });

        wp.customize('sparkconstructionlite_' + settingId + '_bg_color', function (value) {
            value.bind(function (to) {
        ...
        wp.customize('sparkconstructionlite_' + settingId + '_bg_image_url', function (value) {
            value.bind(function (to) {
                var sectionClass = '#' + settingId + '-section';
        ...
        wp.customize('sparkconstructionlite_' + settingId + '_overlay_color', function (value) {
            value.bind(function (to) {
                var sectionClass = '#' + settingId + '-section';
        ...
        wp.customize('sparkconstructionlite_' + settingId + '_padding', function (value) {
            value.bind(function (to) {
                ...
                sparkconstructionlite_set_dynamic_css('sparkconstructionlite_' + settingId + 'padding_desktop', css);
                ...
                if (($(window).width() >= 700) && ($(window).width() < 992)) {
                    ...
                    css += '}';
                    sparkconstructionlite_set_dynamic_css('sparkconstructionlite_' + settingId + 'padding_tablet', css);
                }
                if ($(window).width() < 500) {
                    ...
                    css += '}';
                    sparkconstructionlite_set_dynamic_css('sparkconstructionlite_' + settingId + 'padding_mobile', css);
                }
        ...
        //Footer
        wp.customize('sparkconstructionlite_' + settingId + '_ts_height_desktop', function (value) {
            value.bind(function (to) {
                ...
                var desktop = to;
                var tablet = wp.customize('sparkconstructionlite_' + settingId + '_ts_height_tablet').get();
                var mobile = wp.customize('sparkconstructionlite_' + settingId + '_ts_height_mobile').get();
                ...
                sparkconstructionlite_set_dynamic_css('sparkconstructionlite_' + settingId + '_ts_height', css);
            });
        });

        wp.customize('sparkconstructionlite_' + settingId + '_ts_height_tablet', function (value) {
            value.bind(function (to) {
                if( settingId === 'footer' ) {
                    var sectionClass = '.footer-seprator .section-seperator.bottom-section-seperator';
                } else {
                ...
                var desktop = wp.customize('sparkconstructionlite_' + settingId + '_ts_height_desktop').get();
                var tablet = to;
                var mobile = wp.customize('sparkconstructionlite_' + settingId + '_ts_height_mobile').get();
        ...
        wp.customize('sparkconstructionlite_' + settingId + '_ts_height_mobile', function (value) {
            value.bind(function (to) {
                if( settingId === 'footer' ) {
                    var sectionClass = '.footer-seprator .section-seperator.bottom-section-seperator';
                } else {
        ...
        //Breadcrumb
        wp.customize('sparkconstructionlite_' + settingId + '_bs_color', function (value) {
            value.bind(function (to) {
                $( '.breadcrumb-seprator .bottom-section-seperator svg' ).css( 'fill', to );
            });
        });
        
        wp.customize('sparkconstructionlite_' + settingId + '_bs_height_desktop', function (value) {
            value.bind(function (to) {
                ...
                var desktop = to;
                var tablet = wp.customize('sparkconstructionlite_' + settingId + '_bs_height_tablet').get();
                var mobile = wp.customize('sparkconstructionlite_' + settingId + '_bs_height_mobile').get();
                ...
                sparkconstructionlite_set_dynamic_css('sparkconstructionlite_' + settingId + '_bs_height', css);
            });
        });

        wp.customize('sparkconstructionlite_' + settingId + '_bs_height_tablet', function (value) {
            value.bind(function (to) {
                if( settingId === 'titlebar' ) {
                    var sectionClass = '.breadcrumb-seprator .section-seperator.bottom-section-seperator';
                } else {
                ...
                var desktop = wp.customize('sparkconstructionlite_' + settingId + '_bs_height_desktop').get();
                var tablet = to;
                var mobile = wp.customize('sparkconstructionlite_' + settingId + '_bs_height_mobile').get();
        ...
        wp.customize('sparkconstructionlite_' + settingId + '_bs_height_mobile', function (value) {
            value.bind(function (to) {
                if( settingId === 'titlebar' ) {
                    var sectionClass = '.breadcrumb-seprator .section-seperator.bottom-section-seperator';
                } else {
     ...
     * Slider 
    */
    wp.customize('sparkconstructionlite_slider_height', function (value) {
        value.bind(function (to) {
            var css = '.sparkconstructionlite-slider-item-wrap{ height:' + to + 'px;}'; 
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_slider_height', css);
        });
    });
    wp.customize('sparkconstructionlite_banner_overlay_color', function (value) {
        value.bind(function (to) {
            $('.sparkconstructionlite-banner-bg-overlay').css('background-color', to);
        });
    });

    /** Slider Title */
    wp.customize('sparkconstructionlite_caption_title_font_size', function (value) {
        value.bind(function (to) {
            var css = '.sparkconstructionlite-banner-caption .sparkconstructionlite-banner-title{ font-size:' + to + 'px;}';
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_caption_title_font_size', css);
        });
    });

    /** Slider Caption */
    wp.customize('sparkconstructionlite_caption_width', function (value) {
        value.bind(function (to) {
            var css = '.sparkconstructionlite-banner-caption{ max-width:' + to + '%;}';
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_caption_width', css);
        });
    });
     ...
     * Slider Seperator
    */
    wp.customize('sparkconstructionlite_slider_bottom_seperator', function (value) {
        value.bind(function (to) {
            var seperatorColor = wp.customize('sparkconstructionlite_slider_bs_color').get();
            var css = '.sparkconstructionlite-banner-wrapper .bottom-section-seperator svg{ fill:' + seperatorColor + '}';
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_slider_bottom_seperator', css);
        });
    });

    wp.customize('sparkconstructionlite_slider_bs_color', function (value) {
        value.bind(function (to) {
            $('.bottom-section-seperator svg').css('fill', to);
        });
    });

    wp.customize('sparkconstructionlite_slider_bs_height', function (value) {
        value.bind(function (to) {
            var css = '.section-seperator.bottom-section-seperator{height:' + to + 'px}';
            var tabletHeight = wp.customize('sparkconstructionlite_slider_bs_height_tablet').get();
            var mobileHeight = wp.customize('sparkconstructionlite_slider_bs_height_mobile').get();
            ...
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_slider_bs_height', css);
        });
    });

    wp.customize('sparkconstructionlite_slider_bs_height_tablet', function (value) {
        value.bind(function (to) {
            var desktopHeight = wp.customize('sparkconstructionlite_slider_bs_height').get();
            var mobileHeight = wp.customize('sparkconstructionlite_slider_bs_height_mobile').get();
            ...
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_slider_bs_height_tablet', css);
        });
    });

    wp.customize('sparkconstructionlite_slider_bs_height_mobile', function (value) {
        value.bind(function (to) {
            var desktopHeight = wp.customize('sparkconstructionlite_slider_bs_height').get();
            var tabletHeight = wp.customize('sparkconstructionlite_slider_bs_height_tablet').get();
            ...
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_slider_bs_height_mobile', css);
        });
    });
    ...
    jQuery(document).ready(function ($) {
        wp.customize.selectiveRefresh.bind('partial-content-rendered', function (placement) {
            ...
            if (p_p_id == 'sparkconstructionlite_slider_refresh') {
                var brtl = false;
            ...
            if (p_p_id == 'sparkconstructionlite_aboutus_settings') {
            ...
            if (p_p_id == 'sparkconstructionlite_testimonial_refresh') {
            ...
            if (p_p_id == 'sparkconstructionlite_team_options_refresh') {
            ...
            if (p_p_id == 'sparkconstructionlite_client_refresh') {
            ...
            if (p_p_id == 'sparkconstructionlite_counter_section_refresh') {
                $count = $('.counternumber');
            ...
            if (p_p_id == 'sparkconstructionlite_home_blog_section_refresh') {
            ...
            if (p_p_id == 'sparkconstructionlite_portfolio_section_refresh') {
     ...
     * About Section
    */
    wp.customize('sparkconstructionlite_aboutus_layout_design', function (value) {
        value.bind(function (to) {
            $('.about_us_front').removeClass('layoutone layouttwo layoutthree').addClass(to);
        })
    });

    wp.customize('sparkconstructionlite_about_image', function (value) {
        value.bind(function (to) {
            $('.about-wrapper .about-img img').attr('src', to);
        })
    });

    wp.customize('sparkconstructionlite_aboutus_super_title', function (value) {
        value.bind(function (to) {
            $('.about-right .super-title').html(to);
        })
    });

    wp.customize('sparkconstructionlite_aboutus_button_text', function (value) {
        value.bind(function (to) {
     ...
     * Features Service 
     */
    wp.customize('sparkconstructionlite_promo_service_icon', function (value) {
        value.bind(function (to) {
            $('.feature-service-icon').css('margin-top', to +'px');
        })
    });

    wp.customize('sparkconstructionlite_promoservice_show_icon', function (value) {
        value.bind(function (to) {
            if (to === 'enable') {
    ...
    wp.customize('sparkconstructionlite_promoservice_icon_style', function (value) {
        value.bind(function (to) {
            ...
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_promoservice_icon_style', css);
        });
    });
     ...
     * Service Section
    */
    wp.customize('sparkconstructionlite_service_button', function (value) {
        value.bind(function (to) {
            $('.service-section .feature_detail a.btn').html(to);
        })
    });

    wp.customize('sparkconstructionlite_service_bg_url', function (value) {
        value.bind(function (to) {
     ...
     * Call To Action
    */
    wp.customize('sparkconstructionlite_cta_style', function (value) {
        value.bind(function (to) {
            $('.calltoaction-section').removeClass('classic cover').addClass(to);
        })
    });

    wp.customize('sparkconstructionlite_cta_layout', function (value) {
        value.bind(function (to) {
            $('.inner-section-wrap').removeClass('cta-left cta-right cta-above cta-below').addClass(to);
        })
    });

    wp.customize('sparkconstructionlite_cta_alignment', function (value) {
        value.bind(function (to) {
            $('.calltoaction-section').removeClass('start center end').addClass(to);
        })
    });

    wp.customize('sparkconstructionlite_call_to_action_title', function (value) {
        value.bind(function (to) {
            $('.call-to-action-content-wrap h3').html(to);
        })
    });

    wp.customize('sparkconstructionlite_call_to_action_subtitle', function (value) {
        value.bind(function (to) {
            $('.call-to-action-content-wrap p').html(to);
        })
    });

    wp.customize('sparkconstructionlite_call_to_action_button', function (value) {
        value.bind(function (to) {
            $('.call-to-action-button-wrap a.btn-primary').html(to);
        })
    });

    wp.customize('sparkconstructionlite_call_to_action_button_one', function (value) {
        value.bind(function (to) {
            $('.call-to-action-button-wrap a.style-white').html(to);
        })
    });

    wp.customize('sparkconstructionlite_calltoaction_height', function (value) {
        value.bind(function (to) {
            var css = '.call-to-action-bg-img img{ height:' + to + 'px;}'; 
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_calltoaction_height', css);
        });
    });

    wp.customize('sparkconstructionlite_cta_title_font_size', function (value) {
        value.bind(function (to) {
            $('.call-to-action-content-wrap h2').css('font-size', to + 'px');
        });
    });

    wp.customize('sparkconstructionlite_cta_desc_font_size', function (value) {
        value.bind(function (to) {
            $('.call-to-action-content-wrap p').css('font-size', to + 'px');
        });
    });

    wp.customize('sparkconstructionlite_calltoaction_box_bg_color', function (value) {
        value.bind(function (to) {
            var css = ".call-to-action-content-wrap, .cover .call-to-action-content-wrap{ background-color:" + to + " }";
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_calltoaction_box_bg_color', css);
        });
    });

    wp.customize('sparkconstructionlite_calltoaction_text_color', function (value) {
        value.bind(function (to) {
            var css = ".call-to-action-content-wrap p { color:" + to + " }";
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_calltoaction_text_color', css);
        });
    });
    ...
    */
    wp.customize('sparkconstructionlite_video_calltoaction_height', function (value) {
        value.bind(function (to) {
            var css = '.video-cat-image-wrap img{ height:' + to + 'px;}'; 
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_video_calltoaction_height', css);
        });
    });

    wp.customize('sparkconstructionlite_video_calltoaction_box_bg_color', function (value) {
        value.bind(function (to) {
            var css = ".video-cat-image-wrap::after, .video-cta-section .contact-form{ background-color:" + to + " }";
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_video_calltoaction_box_bg_color', css);
        });
    });
     ...
     * Our Team Member
    */
    wp.customize('sparkconstructionlite_team_block_height', function (value) {
        value.bind(function (to) {
            var css = '.team-member-block-image img{ height:' + to + 'px;}'; 
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_team_block_height', css);
        });
    });
    ...
    */
    wp.customize('sparkconstructionlite_testimonial_designation_color', function (value) {
        value.bind(function (to) {
            var css =".testimonial-block-content .designation, .style2 .testimonial-block-inner-content .designation{ color:" + to + "}";
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_testimonial_designation_color', css);
        });
    });
     ...
     * Counter Icon 
    */
    wp.customize('sparkconstructionlite_counter_display_style', function (value) {
        value.bind(function (to) {
            $('.counter-block-wrapper').removeClass('left right above below').addClass(to);
        })
    });
    wp.customize('sparkconstructionlite_counter_icon_disable', function (value) {
        value.bind(function (to) {
            if( to === 'enable' ) {
     ...
     * Gallery Block
    */
    wp.customize('sparkconstructionlite_gallery_default_text', function (value) {
        value.bind(function (to) {
            $('.default-item-name').html(to);
        })
    });
    wp.customize('sparkconstructionlite_gallery_tab_align', function (value) {
        value.bind(function (to) {
            $('.sparkconstructionlite-gallery-item-wrap').removeClass('start end center').addClass(to);
        })
    });
    wp.customize('sparkconstructionlite_gallery_caption_disable', function (value) {
        value.bind(function (to) {
            if( to === 'enable' ) {
                $( '.sparkconstructionlite-gallery-caption' ).css( { 'display': 'flex' } );
            } else {
                $( '.sparkconstructionlite-gallery-caption' ).css( { 'display': 'none' } );
            }
        });
    });
    wp.customize('sparkconstructionlite_gallery_zoom_icon_disable', function (value) {
        value.bind(function (to) {
            if( to === 'enable' ) {
                $( '.sparkconstructionlite-gallery-image-large' ).css( { 'display': 'block' } );
            } else {
                $( '.sparkconstructionlite-gallery-image-large' ).css( { 'display': 'none' } );
            }
        });
    });
     ...
     * Home Blog Block
    */
    wp.customize('sparkconstructionlite_blog_home_btn', function (value) {
        value.bind(function (to) {
            $('#blog-section .inner-section-wrap .ikthemes-article-item a.btn').html(to);
        })
    });
    wp.customize('sparkconstructionlite_home_blog_alignment', function (value) {
        value.bind(function (to) {
            $('#blog-section .inner-section-wrap .ikthemes-article-item').removeClass('text-center text-left text-right').addClass(to);
        })
    });

    wp.customize('sparkconstructionlite_home_post_date_options', function (value) {
        value.bind(function (to) {
            if( to === 'enable' ) {
    ...
    wp.customize('sparkconstructionlite_home_post_author_options', function (value) {
        value.bind(function (to) {
            if( to === 'enable' ) {
    ...
    wp.customize('sparkconstructionlite_home_post_reading_time', function (value) {
        value.bind(function (to) {
            if( to === 'enable' ) {
     ...
     * Blog Template
    */
    wp.customize('sparkconstructionlite_post_column', function (value) {
        value.bind(function (to) {
    ...
    wp.customize('sparkconstructionlite_blog_post_space', function (value) {
        value.bind(function (to) {
            $( '.ikthemes-article-wrap' ).css( { 'gap': to + 'rem' } );
        });
    });

    wp.customize('sparkconstructionlite_blog_alignment', function (value) {
        value.bind(function (to) {
    ...
    wp.customize('sparkconstructionlite_blogtemplate_btn', function (value) {
        value.bind(function (to) {
    ...
    wp.customize('sparkconstructionlite_post_date_options', function (value) {
        value.bind(function (to) {
            if( to === 'enable' ) {
                $( '.entry-meta.info span.posted-on, .ikthemes-article-date' ).css( { 'display': 'inline-block' } );
            } else {
    ...
    wp.customize('sparkconstructionlite_post_comments_options', function (value) {
        value.bind(function (to) {
            if( to === 'enable' ) {
    ...
    wp.customize('sparkconstructionlite_post_author_options', function (value) {
        value.bind(function (to) {
            if( to === 'enable' ) {
                $( '.entry-meta.info span.byline' ).css( { 'display': 'block' } );
            } else {
    ...
    wp.customize('sparkconstructionlite_post_reading_time', function (value) {
        value.bind(function (to) {
            if( to === 'enable' ) {
                $( '.entry-meta.info span.reading-time' ).css( 'display', 'inline-block' );
            } else {
    ...
    /** Single Post */
    wp.customize('sparkconstructionlite_blog_single_alignment', function (value) {
        value.bind(function (to) {
            var removeClasses = 'text-left text-center text-right';
            $( '.singlearticle .sparkconstructionlite-article-wrap' ).removeClass( removeClasses ).addClass( to );
        });
    });
     ...
     * Footer
    */
     wp.customize('sparkconstructionlite_footer_column', function (value) {
        value.bind(function (to) {
    ...
    wp.customize('sparkconstructionlite_footer_bg_color', function (value) {
        value.bind(function (to) {
            $( '.footer-seprator .section-seperator svg' ).css( 'fill', to );
        });
    });
    
    wp.customize('sparkconstructionlite_footer_top_seperator', function (value) {
        value.bind(function (to) {
            var seperatorColor = wp.customize('sparkconstructionlite_footer_ts_color').get();
            var css = '.footer-seprator .section-seperator svg{ fill:' + seperatorColor + '}';
            sparkconstructionlite_set_dynamic_css('sparkconstructionlite_footer_top_seperator', css);
        });
    });

    wp.customize('sparkconstructionlite_footer_ts_color', function (value) {
        value.bind(function (to) {
            $( '.footer-seprator .section-seperator svg' ).css( 'fill', to );
        });
    });
