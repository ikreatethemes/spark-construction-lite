...
$excerpt_count = get_theme_mod( 'sparkconstructionlite_post_excerpt_length', 20 );

$alignment = get_theme_mod('sparkconstructionlite_blog_alignment', 'text-center');

$blogreadmore_btn = get_theme_mod( 'sparkconstructionlite_blogtemplate_btn', 'Read More' );
...
<article id="post-<?php the_ID(); ?>" <?php post_class('ikthemes-article-item article ' .$alignment); ?>>
	...
	<div class="ikthemes-article-content">
		<?php 
			...
			if ( 'post' === get_post_type() ){ do_action( 'sparkconstructionlite_themes_post_meta', 10 ); } 
		?>
