<?php
  ...
  * Slug: sparkconstructionlite/quick-contact
  * Categories: sparkconstructionlite
  * Keywords: contact, quick contact, contact section
  */
?>
<!-- wp:group {"metadata":{"name":"Quick Contact Area","categories":["sparkconstructionlite"],"patternName":"sparkconstructionlite/quick-contact"},"layout":{"type":"constrained"}} -->
...
<h2 class="wp-block-heading has-text-align-center has-white-color has-text-color"><?php esc_html_e('Start your journey','spark-construction-lite'); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"white","fontSize":"medium"} -->
<p class="has-text-align-center has-white-color has-text-color has-medium-font-size"><?php esc_html_e('Molestie ac feugiat sed lectus vestibulum mattis ullamcorper Amet nulla facilisi morbi tempus iaculis urna id volutpat. Tempor commodo ullamcorper a lacus','spark-construction-lite'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h5 class="wp-block-heading has-black-color has-text-color"><?php esc_html_e('Start exploring the world today!','spark-construction-lite'); ?></h5>
<!-- /wp:heading -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"className":"is-style-fill"} -->
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button" href="#"><?php esc_html_e('Contact us','spark-construction-lite'); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
...
<h3 class="wp-block-heading has-text-align-left has-white-color has-text-color"><?php esc_html_e('Read our travel blog','spark-construction-lite'); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"white"} -->
<p class="has-white-color has-text-color"><?php esc_html_e('A wonderful serenity has taken possession of my entire, like these sweet mornings of spring which I enjoy with my heart.','spark-construction-lite'); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-no-border"><a class="wp-block-button__link has-white-color has-text-color has-link-color wp-element-button" href="#"><?php esc_html_e('Read More','spark-construction-lite'); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<h3 class="wp-block-heading has-text-align-left"><?php esc_html_e('Quick Contact support','spark-construction-lite'); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e('Have a question? the professional support team is ready to answer your questions. which I enjoy with my whole heart.','spark-construction-lite'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{":hover":{"color":{"text":"var:preset|color|primary"}},"color":{"text":"var:preset|color|secondary"}}}}} -->
<p class="has-link-color"><a href="mailto:example@example.com"><strong><?php esc_html_e('example@example.com','spark-construction-lite'); ?></strong></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
