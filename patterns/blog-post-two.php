<?php
 /**
  * Title: Blog Post Two
  * Slug: sparkconstructionlite/blog-post-two
  * Categories: sparkconstructionlite
  * Keywords: blog post, artical, two artical, columns
  */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Blog Layout Two","categories":["sparkconstructionlite"],"patternName":"sparkconstructionlite/blog-post-two"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|lg","bottom":"var:preset|spacing|lg"}}},"layout":{"type":"constrained"}} -->
...
<p class="has-text-align-left super-title" style="font-style:normal;font-weight:600"><?php esc_html_e('Our Latest Posts','spark-construction-lite'); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","align":"full"} -->
<h2 class="wp-block-heading alignfull has-text-align-center"><?php esc_html_e('Construction News & Articles','spark-construction-lite'); ?></h2>
<!-- /wp:heading -->
