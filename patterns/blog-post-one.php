<?php
 /**
  * Title: Blog Post One
  * Slug: sparkconstructionlite/blog-post-one
  * Categories: sparkconstructionlite
  * Keywords: blog post, artical, blog post section, post area
  */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Blog Layout One","categories":["sparkconstructionlite"],"patternName":"sparkconstructionlite/blog-post-one"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|lg","bottom":"var:preset|spacing|lg"}}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-group alignwide" style="padding-bottom:var(--wp--preset--spacing--40)">
  ...
  <div class="wp-block-group alignwide section-title-wrapper">  
    ...
    <p class="has-text-align-left super-title" style="font-style:normal;font-weight:600">
      <?php esc_html_e('Our Latest Posts','spark-construction-lite'); ?>
    </p>
    <!-- /wp:paragraph -->

    <!-- wp:heading {"textAlign":"center","align":"full"} -->
    <h2 class="wp-block-heading alignfull has-text-align-center">
      <?php esc_html_e('Construction News & Articles','spark-construction-lite'); ?>
    </h2>
    <!-- /wp:heading -->
