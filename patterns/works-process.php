<?php
 /**
  * Title: Works Process
  * Slug: sparkconstructionlite/works-process
  * Categories: sparkconstructionlite
  * Keywords: works process, working process, process area, works process section, process
  */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Works Process","categories":["sparkconstructionlite"],"patternName":"sparkconstructionlite/works-process"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|lg","bottom":"var:preset|spacing|lg"}}},"layout":{"type":"constrained"}} -->
    ...
    <!-- wp:group {"layout":{"type":"constrained","wideSize":"1020px"}} -->
      <div class="wp-block-group">
        ...
        <p class="has-text-align-center">
          <?php esc_html_e('Welcome and thank you for installing the free WordPress theme. Construction is a clean, beautiful, and fully customizable responsive modern free WordPress construction theme, especially for landing pages.','spark-construction-lite'); ?>
        </p>
        <!-- /wp:paragraph -->
      </div>
    <!-- /wp:group -->
...
<h3 class="wp-block-heading has-text-align-right"><a href="#"><?php esc_html_e('Easy Online Booking','spark-construction-lite'); ?></a></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"right"} -->
<p class="has-text-align-right"><?php esc_html_e('WordPress theme is a clean, beautiful, and fully customizable responsive modern free WordPress construction theme, especially for App-related landing pages.','spark-construction-lite'); ?></p>
<!-- /wp:paragraph -->
...
<h4 class="wp-block-heading has-text-align-left" style="font-size:24px;font-style:normal;font-weight:600"><a href="#"><?php esc_html_e('Work Processing','spark-construction-lite'); ?></a></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left"} -->
<p class="has-text-align-left"><?php esc_html_e('Leverage framework agile to provide a robust synopsis for overviews. Corporate strategy fosters thinking to further the overall value proposition.','spark-construction-lite'); ?></p>
<!-- /wp:paragraph -->
...
<h4 class="wp-block-heading has-text-align-right" style="font-size:24px;font-style:normal;font-weight:600"><a href="#"><?php esc_html_e('Success Project','spark-construction-lite'); ?></a></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"right"} -->
<p class="has-text-align-right"><?php esc_html_e('Have a question? Our professional support is ready to answer your questions. All our team member support requests will be replied in 24 hours or less.','spark-construction-lite'); ?></p>
<!-- /wp:paragraph -->
