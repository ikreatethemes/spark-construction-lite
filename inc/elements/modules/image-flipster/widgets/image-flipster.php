...
namespace SparkConstructionLiteElements\Modules\ImageFlipster\Widgets;
...
class ImageFlipster extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Image Flipster Carousel', 'spark-construction-lite');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_settings', [
                'label' => esc_html__('Layouts', 'spark-construction-lite'),
            ]
        );
            ...
            $this->add_control(
                'layout', [
                    ...
                    'default' => 'carousel',
                    'options' => [
                        'carousel' => esc_html__('Carousel', 'spark-construction-lite'),
                        'coverflow' => esc_html__('Coverflow', 'spark-construction-lite')
                    ],
                ]
            );
            ...
            $this->add_control(
                'image_stretch', [
                    'label' => esc_html__('Image Stretch', 'spark-construction-lite'),
                    'type' => Controls_Manager::SELECT,
                    'label_block' => true,
                    'default' => 'ikthemes-image-stretch-yes',
                    'options' => [
                        'ikthemes-image-stretch-yes' => esc_html__('Yes', 'spark-construction-lite'),
                        'ikthemes-image-stretch-no' => esc_html__('No', 'spark-construction-lite')
                    ],
                ]
            );
            ...
            $this->add_control(
                'enable_nav', [
                    'label' => esc_html__('Navigation Buttons', 'spark-construction-lite'),
            ...
            $this->add_control(
                'nav_position', [
                    ...
                    'options' => [
                        'ikthemes-nav-bottom' => esc_html__('Bottom Center', 'spark-construction-lite'),
                        'ikthemes-nav-side' => esc_html__('Middle Side Ways', 'spark-construction-lite')
                    ],
                    'condition' => [
                        'enable_nav' => 'yes',
                    ],
        ...
        $this->start_controls_section(
            ...
            $repeater->add_control(
                'title', [
                    ...
                    'label_block' => true,
                    'default' => esc_html__('FlipSter Image', 'spark-construction-lite'),
                ]
            );
            ...
            $this->add_control(
                'slides',[
                    'label' => esc_html__( 'FlipSter Image List', 'spark-construction-lite' ),
                    ...
                    'default' => [
                        [
                            ...
                            'title' => esc_html__( 'FlipSter Image One', 'spark-construction-lite' ),
                            'logo_link' => '#',
                            'link_new_tab' => 'yes',
                        ],
                        [
                            'image' => Utils::get_placeholder_image_src(),
                            'title' => esc_html__( 'FlipSter Image Two', 'spark-construction-lite' ),
                            'logo_link' => '#',
                            'link_new_tab' => 'yes',
                        ],
                        [
                            'image' => Utils::get_placeholder_image_src(),
                            'title' => esc_html__( 'FlipSter Image Three', 'spark-construction-lite' ),
                            'logo_link' => '#',
                            'link_new_tab' => 'yes',
                        ],
                        [
                            'image' => Utils::get_placeholder_image_src(),
                            'title' => esc_html__( 'FlipSter Image Four', 'spark-construction-lite' ),
                            'logo_link' => '#',
                            'link_new_tab' => 'yes',
                        ],
                        [
                            'image' => Utils::get_placeholder_image_src(),
                            'title' => esc_html__( 'FlipSter Image Five', 'spark-construction-lite' ),
                            'logo_link' => '#',
                            'link_new_tab' => 'yes',
                        ],
                        [
                            'image' => Utils::get_placeholder_image_src(),
                            'title' => esc_html__( 'FlipSter Image Six', 'spark-construction-lite' ),
                            'logo_link' => '#',
                            'link_new_tab' => 'yes',
                        ]
                    ],
            ...
            $this->add_control(
                'link_new_tab', [
                    'label' => esc_html__('Open Link in New Tab', 'spark-construction-lite'),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => esc_html__('Yes', 'spark-construction-lite'),
                    'label_off' => esc_html__('No', 'spark-construction-lite'),
                    'return_value' => 'yes',
        ...
        $this->start_controls_section(
            'navigation_style', [
                'label' => esc_html__('Navigation Button', 'spark-construction-lite'),
