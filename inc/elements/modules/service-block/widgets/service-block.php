...
namespace SparkConstructionLiteElements\Modules\ServiceBlock\Widgets;
...
class ServiceBlock extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Service Block', 'spark-construction-lite');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'serviceicon', [
                    'label' => esc_html__('Service Icon', 'spark-construction-lite'),
            ...
            $this->add_responsive_control(
                'box_width', [
                    'label' => esc_html__('Box Width', 'spark-construction-lite'),
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-service-area .sparkconstructionlite-service-detail .sparkconstructionlite-service-box' => 'width: {{SIZE}}{{UNIT}};'
                    ],
                    'condition' => [
                        'layout' => ['style1'],
                    ],
            ...
            $this->add_control(
                'image_height', [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-service-area.style2 .sparkconstructionlite-top-content img, {{WRAPPER}} .sparkconstructionlite-service-area.style2 .sparkconstructionlite-bottom-content' => 'min-height: {{SIZE}}{{UNIT}};',
                    ],
                    'condition' => [
                        'custom_height' => 'yes',
                    ],
            ...
            $repeater->add_control(
                'service_title', [
                    ...
                    'label_block' => true,
                    'default' => esc_html__('Your Service Heading', 'spark-construction-lite')
                ]
            );
            ...
            $this->add_control(
                'service_blocks',[
                    'label' => esc_html__( 'Service Items', 'spark-construction-lite' ),
                    ...
                    'default' => [
                        [
                            ...
                            'service_title' => esc_html__( 'Your Service 1 Heading', 'spark-construction-lite' ),
                        ...
                        [
                            ...
                            'service_title' => esc_html__( 'Your Service 2 Heading', 'spark-construction-lite' ),
                            'service_description' => esc_html__( 'End your search here! Unlock Our Premium Themes to launch your website. All themes are user-friendly and fully customizable.', 'spark-construction-lite' ),
                            'service_button_text' => esc_html__( 'Read More', 'spark-construction-lite' ),
                            'service_button_link' => '#',
                            'link_icon' => [
                        ...
                        [
                            ...
                            'service_title' => esc_html__( 'Your Service 3 Heading', 'spark-construction-lite' ),
                            'service_description' => esc_html__( 'End your search here! Unlock Our Premium Themes to launch your website. All themes are user-friendly and fully customizable.', 'spark-construction-lite' ),
                            'service_button_text' => esc_html__( 'Read More', 'spark-construction-lite' ),
                            'service_button_link' => '#',
                            'link_icon' => [
                        ...
                        [
                            ...
                            'service_title' => esc_html__( 'Your Service 4 Heading', 'spark-construction-lite' ),
                            'service_description' => esc_html__( 'End your search here! Unlock Our Premium Themes to launch your website. All themes are user-friendly and fully customizable.', 'spark-construction-lite' ),
                            'service_button_text' => esc_html__( 'Read More', 'spark-construction-lite' ),
                            'service_button_link' => '#',
                            'link_icon' => [
                        ...
                        [
                            ...
                            'service_title' => esc_html__( 'Your Service 5 Heading', 'spark-construction-lite' ),
                            'service_description' => esc_html__( 'End your search here! Unlock Our Premium Themes to launch your website. All themes are user-friendly and fully customizable.', 'spark-construction-lite' ),
                            'service_button_text' => esc_html__( 'Read More', 'spark-construction-lite' ),
                            'service_button_link' => '#',
                            'link_icon' => [
                        ...
                        [
                            ...
                            'service_title' => esc_html__( 'Your Service 6 Heading', 'spark-construction-lite' ),
                            'service_description' => esc_html__( 'End your search here! Unlock Our Premium Themes to launch your website. All themes are user-friendly and fully customizable.', 'spark-construction-lite' ),
                            'service_button_text' => esc_html__( 'Read More', 'spark-construction-lite' ),
                            'service_button_link' => '#',
                            'link_icon' => [
        ...
        $this->start_controls_section(
            'general_styles', [
                'label' => esc_html__('Service Style', 'spark-construction-lite'),
            ...
            $this->add_control(
                'item_bg_color', [
                    ...
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-service-area .sparkconstructionlite-service-item-block, 
                        {{WRAPPER}} .sparkconstructionlite-service-area.style2 .sparkconstructionlite-bottom-content'=> 'background-color: {{VALUE}}',
                    ]
                ]
            );
            ...
            $this->add_control(
                'content_vertical_alignment',[
                    ...
                    'toggle' => false,
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-service-area .sparkconstructionlite-service-item-block' => 'align-items: {{VALUE}};',
                    ],
            ...
            $this->add_responsive_control(
                'servive_space',[
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-service-area .sparkconstructionlite-service-item-block .sparkconstructionlite-service-wrap, 
                        {{WRAPPER}} .sparkconstructionlite-service-area.style2 .sparkconstructionlite-bottom-content,
                        {{WRAPPER}} .sparkconstructionlite-service-area.style3 .sparkconstructionlite-bottom-content,
                        {{WRAPPER}} .sparkconstructionlite-service-area.style4 .sparkconstructionlite-bottom-content' => 'gap: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                'text_align',[
                    ...
                    'options' => [
                        'default' => [
                            'title' => esc_html__( 'Default', 'spark-construction-lite' ),
                    ...
                    'render_type' => 'template',
                    'prefix_class' => 'sparkconstructionlite-service-alignment-',
                    'condition' => [
            ...
            $this->add_responsive_control(
                'item_padding', [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-service-area .sparkconstructionlite-service-item-block, 
                        {{WRAPPER}} .sparkconstructionlite-service-area.style2 .sparkconstructionlite-bottom-content'  => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'condition' => [
                        'layout' => ['style1','style2'],
                    ],
            ...
            $this->add_responsive_control(
                'item_radius', [
                    ...
                    'size_units' => ['px', '%', 'em'],
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-service-area .sparkconstructionlite-service-item-block' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'condition' => [
                        'layout' => ['style1'],
                    ],
            ...
            $this->add_group_control(
                Group_Control_Box_Shadow::get_type(),[
                    ...
                    'selector' => '{{WRAPPER}} .sparkconstructionlite-service-area .sparkconstructionlite-service-item-block',
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                'icon_size', [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-icon-boxicon.elementor-icon, 
                        {{WRAPPER}} .sparkconstructionlite-service-area.style2 .sparkconstructionlite-bottom-content .sparkconstructionlite-icon-boxicon .elementor-icon' => 'font-size: {{SIZE}}{{UNIT}};'
                    ],
                ]
            );
            ...
            $this->add_control(
                'icon_color', [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-service-area .sparkconstructionlite-service-item-block .sparkconstructionlite-icon-boxicon, 
                        {{WRAPPER}} .sparkconstructionlite-service-area.style2 .sparkconstructionlite-bottom-content .sparkconstructionlite-icon-boxicon .elementor-icon' => 'color: {{VALUE}}; fill: {{VALUE}};'
                    ],
                ]
            );
            ...
            $this->add_control(
                'icon_bg_color', [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-service-area.style2 .sparkconstructionlite-bottom-content .sparkconstructionlite-icon-boxicon' => 'background-color: {{VALUE}}',
                    ],
                    'condition' => [
                        'layout' => ['style2'],
                    ],
        ...
        $this->start_controls_section(
            'count_style', [
                'label' => esc_html__('Number Count', 'spark-construction-lite'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'layout' => ['style3'],
                ],
            ...
            $this->add_control(
                'count_color', [
                    ...
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-service-count' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                Group_Control_Typography::get_type(), [
                    ...
                    'selector' => '{{WRAPPER}} .sparkconstructionlite-service-count',
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'title_color', [
                    ...
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-item-title' => 'color: {{VALUE}}',
                        '{{WRAPPER}} .sparkconstructionlite-item-title a' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                Group_Control_Typography::get_type(), [
                    ...
                    'label' => esc_html__('Typography', 'spark-construction-lite'),
                    'selector' => '{{WRAPPER}} .sparkconstructionlite-item-title',
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'description_color', [
                    ...
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-item-description' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                Group_Control_Typography::get_type(), [
                    ...
                    'label' => esc_html__('Typography', 'spark-construction-lite'),
                    'selector' => '{{WRAPPER}} .sparkconstructionlite-item-description',
                ]
            );
		...
		$this->start_controls_section(
            ...
            $this->add_group_control(
                Group_Control_Border::get_type(), [
                    'name' => 'image_border',
                    'selector' => '{{WRAPPER}} .sparkconstructionlite-top-content, {{WRAPPER}} .sparkconstructionlite-feature-service-img',
                    'separator' => 'before',
                ]
            );
                ...
                $this->start_controls_tab( 'bg_normal_effect',[
                    ...
                    $this->add_group_control(
						Group_Control_Background::get_type(),[
							...
							'types' => [ 'classic', 'gradient' ],
							'exclude' => [ 'image' ],
							'selector' => '{{WRAPPER}} .sparkconstructionlite-service-area.style2 .sparkconstructionlite-service-image::after, {{WRAPPER}} .sparkconstructionlite-feature-image::after',
							'fields_options' => [
								'background' => [
									'default' => 'classic',
								],
                    ...
                    $this->add_group_control(
                        Group_Control_Css_Filter::get_type(),[
                            'name' => 'bg_filters',
                            'selector' => '{{WRAPPER}} .sparkconstructionlite-service-image, {{WRAPPER}} .sparkconstructionlite-feature-image',
                        ]
                    );
                    ...
                    $this->add_control(
                        'overlay_blend_mode',[
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .sparkconstructionlite-service-image, {{WRAPPER}} .sparkconstructionlite-feature-image' => 'mix-blend-mode: {{VALUE}}',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab( 'bg_normal_hover_effect',[
                    ...
                    $this->add_group_control(
                        Group_Control_Background::get_type(),[
                            ...
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .sparkconstructionlite-top-content:hover .sparkconstructionlite-service-image::after, {{WRAPPER}} .sparkconstructionlite-top-content:focus .sparkconstructionlite-service-image::after,
                                            {{WRAPPER}} .sparkconstructionlite-feature-service-img:hover .sparkconstructionlite-feature-image::after, {{WRAPPER}} .sparkconstructionlite-feature-service-img:focus .sparkconstructionlite-feature-image::after',
                            'exclude' => [ 'image' ],
                            'fields_options' => [
                                'background' => [
                                    'default' => 'classic',
                    ...
                    $this->add_group_control(
                        Group_Control_Css_Filter::get_type(),[
                            ...
                            'selector' => '{{WRAPPER}} .sparkconstructionlite-top-content:hover .sparkconstructionlite-service-image::after, {{WRAPPER}} .sparkconstructionlite-feature-service-img:hover .sparkconstructionlite-feature-image::after',
                        ]
                    );
                    ...
                    $this->add_control(
                        'effect_duration',[
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .sparkconstructionlite-service-image, {{WRAPPER}} .sparkconstructionlite-feature-image' => 'transition-duration: {{SIZE}}ms',
                            ],
                            'separator' => 'before',
                        ]
                    );
    ...
    protected function render() {
            ...
            $this->add_render_attribute('wrapper', 'class', [
                    'sparkconstructionlite-service-area',
                    $layout,
                ]
            );

            $this->add_render_attribute( 'title', 'class', ['sparkconstructionlite-item-title'] );
            $this->add_render_attribute( 'description', 'class', ['sparkconstructionlite-item-description'] );
            $this->add_render_attribute( 'button_wrap', 'class', ['sparkconstructionlite-button-wrap'] );
            $this->add_render_attribute( 'button', 'class', ['sparkconstructionlite-item-link'] );
        ?>
        ...
        <<?php Utils::print_validated_html_tag( $wrapper_tag ); ?> <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
            ...
            <?php if( !empty( $layout ) && $layout == 'style1' ){ 
                ...
                ?>
                    <div class="sparkconstructionlite-service-detail">
                        <div class="sparkconstructionlite-leftdata sparkconstructionlite-service-box">
                            <?php 
                                foreach($leftArray as $leftindex => $leftpage): 

                                    $this->add_render_attribute('wrapper_'.$leftindex, 'class', ['sparkconstructionlite-service-item-block']);
                                    $this->add_render_attribute( 'leftbutton_'.$leftindex, 'class', ['sparkconstructionlite-item-link'] );
                                    $this->add_render_attribute( 'leftonlybutton_'.$leftindex, 'class', ['sparkconstructionlite-button','sparkconstructionlite-button-noborder'] );
                            ...
                            ?>
                                <<?php Utils::print_validated_html_tag( $wrapper_tag ); ?> <?php $this->print_render_attribute_string( 'wrapper_'.$leftindex ); ?>>
                                    <?php if( $serviceicon == 'yes' ){ ?>
                                        <div class="sparkconstructionlite-icon-boxicon elementor-icon">
                                            <?php Icons_Manager::render_icon( $leftpage['service_icon'], ['aria-hidden' => 'true'] ); ?>
                                        </div>
                                    <?php } ?>
                                    <div class="sparkconstructionlite-service-wrap">
                        ...
                        <div class="sparkconstructionlite-feature-service-img sparkconstructionlite-bg-transform-<?php echo esc_attr( $settings['transformation'] ); ?>">
                            <div class="sparkconstructionlite-feature-image sparkconstructionlite-bg">
                                <?php Group_Control_Image_Size::print_attachment_image_html( $settings, 'service_bg_url' ); ?>
                            </div>
                        </div>

                        <div class="sparkconstructionlite-rightdata sparkconstructionlite-service-box">
                            <?php
                                foreach($rightArray as $rightindex => $rightpage):
                                    
                                    $this->add_render_attribute('wrapper_'.$rightindex, 'class', ['sparkconstructionlite-service-item-block']);
                                    $this->add_render_attribute( 'rightbutton_'.$rightindex, 'class', ['sparkconstructionlite-item-link'] );
                                    $this->add_render_attribute( 'rightonlybutton_'.$rightindex, 'class', ['sparkconstructionlite-button','sparkconstructionlite-button-noborder'] );
            ...
            <?php } }else if( !empty( $layout ) && $layout == 'style2' ){  ?>
                <div class="sparkconstructionlite-service-item-wrap">  
                    <?php 
                        $button_tag = 'a';
                        ...
                        foreach($pages as $pageindex => $page):
                            ...
                            $this->add_render_attribute( "link_{$pageindex}", 
                                'class', [
                                    'sparkconstructionlite-item-link sparkconstructionlite-bg-transform-'.$settings['transformation']
                                ] );
                            
                            $this->add_link_attributes( "linkonlybutton_{$pageindex}", $page['service_button_link'] );
                            $this->add_render_attribute( "linkonlybutton_{$pageindex}", 'class', ['sparkconstructionlite-button','sparkconstructionlite-button-noborder'] );
                    ?>
                        <div class="sparkconstructionlite-service-block">
                            <?php if (!empty( $page['service_image'] )) { ?>
                                <div class="sparkconstructionlite-top-content">
                                    <<?php Utils::print_validated_html_tag( $button_tag ); ?> <?php $this->print_render_attribute_string( "link_{$pageindex}" ); ?>>
                                        <div class="sparkconstructionlite-service-image sparkconstructionlite-bg">
                                            <?php Group_Control_Image_Size::print_attachment_image_html( $page, 'service_image' ); ?>
                                        </div>
                                    </<?php Utils::print_unescaped_internal_string( $button_tag ); ?>>
                                </div>
                            <?php } ?>
                            <div class="sparkconstructionlite-bottom-content">
