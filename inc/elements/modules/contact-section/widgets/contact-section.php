...
namespace SparkConstructionLiteElements\Modules\ContactSection\Widgets;
...
class ContactSection extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Contact Us With Map', 'spark-construction-lite');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $repeater->add_control(
                'contact_detail_icon', [
                    'label' => esc_html__('Contact Icon', 'spark-construction-lite'),
            ...
            $repeater->add_control(
                'contact_detail_label', [
                    'label' => esc_html__('Contact Label', 'spark-construction-lite'),
            ...
            $repeater->add_control(
                'contact_detail_desc', [
                    'label' => esc_html__('Contact Description', 'spark-construction-lite'),
                    'type' => Controls_Manager::TEXTAREA,
                    'default' => esc_html__( 'Contact Description' , 'spark-construction-lite' ),
                    'placeholder' => esc_html__('Type your contact description here', 'spark-construction-lite'),
                ]
            );

            $this->add_control(
                'contact_list', [
                    'label' => esc_html__('Contact Detail Items', 'spark-construction-lite'),
                    ...
                    'default' => [
                        [
                            ...
                            'contact_detail_label' => esc_html__( 'Office Location', 'spark-construction-lite' ),
                            'contact_detail_desc' => esc_html__( '5305 Creek CT Garland, TX 75043', 'spark-construction-lite' )
                        ],
                        [
                            'contact_detail_icon' => [
                            ...
                            'contact_detail_label' => esc_html__( 'Phone Number', 'spark-construction-lite' ),
                            'contact_detail_desc' => esc_html__( '+1 - (214) 838-0543 Or (214) 838-0543 ( Give us a free call 24/7 )', 'spark-construction-lite' ),
                        ],
                        [
                            'contact_detail_icon' => [
                            ...
                            'contact_detail_label' => esc_html__( 'Write Us Mail', 'spark-construction-lite' ),
                            'contact_detail_desc' => esc_html__( 'example@example.com Or support@example.com', 'spark-construction-lite' ),
                        ],
                    ],
            ...
            $default_address = esc_html__('London Eye, London, United Kingdom', 'spark-construction-lite');

            $this->add_control(
                'address', [
                    'label' => esc_html__('Location', 'spark-construction-lite'),
                    'type' => Controls_Manager::TEXT,
                    'dynamic' => [
                        'active' => true,
                        'categories' => [
            ...
            $this->add_control(
                'zoom', [
                    'label' => esc_html__('Zoom', 'spark-construction-lite'),
            ...
            $this->add_control(
                'view', [
                    'label' => esc_html__('View', 'spark-construction-lite'),
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                'contact_form_position', [
                    'label' => esc_html__( 'Contact Row Position', 'spark-construction-lite' ),
            ...
            $this->add_responsive_control(
                'contact_form_column_position', [
                    'label' => esc_html__( 'Contact Column Position', 'spark-construction-lite' ),
                    'type' => Controls_Manager::CHOOSE,
                    'options' => [
                        'before' => [
                    ...
                    'prefix_class' => 'sparkconstructionlite-contact-position-',
                    'selectors' => [
        ...
        $this->start_controls_section(
            ...
            $this->start_controls_tabs( 'contact_detail_items' );
                ...
                $this->start_controls_tab(
                    'contact_detail_item', [
                        'label' => esc_html__('Items', 'spark-construction-lite'),
                    ]
                );
                ...
                $this->start_controls_tab(
                    'contact_detail_item_detail', [
                        'label' => esc_html__('Detail', 'spark-construction-lite'),
                    ]
                );
                    ...
                    $this->add_group_control(
                        Group_Control_Typography::get_type(), [
                            ...
                            'label' => esc_html__('Title Typography', 'spark-construction-lite'),
                    ...
                    $this->add_responsive_control(
                        'contact_detail_item_title_margin', [
                            'label' => esc_html__('Title Margin', 'spark-construction-lite'),
                            'type' => Controls_Manager::DIMENSIONS,
                    ...
                    $this->add_group_control(
                        Group_Control_Typography::get_type(), [
                            ...
                            'label' => esc_html__('Content Typography', 'spark-construction-lite'),
                    ...
                    $this->add_responsive_control(
                        'contact_detail_item_content_margin', [
                            'label' => esc_html__('Content Margin', 'spark-construction-lite'),
                            'type' => Controls_Manager::DIMENSIONS,
                            'allowed_dimensions' => 'vertical',
                            'size_units' => ['px', '%', 'em'],
                            'selectors' => [
        ...
        $this->start_controls_section(
            'contact_form_style', [
                'label' => esc_html__('Contact Form', 'spark-construction-lite'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
            ...
            $this->add_control(
                'contact_form_input_text_color', [
                    'label' => esc_html__('Input Text Color', 'spark-construction-lite'),
                    'type' => Controls_Manager::COLOR,
                    'default' => '#112437',
                    'selectors' => [
            ...
            $this->add_control(
                'contact_form_input_border_color', [
                    'label' => esc_html__('Input Border Color', 'spark-construction-lite'),
                    'type' => Controls_Manager::COLOR,
                    'default' => '#eeeeee',
                    'selectors' => [
                        '{{WRAPPER}} .ikthemes-contact-form input[type="text"],
            ...
            $this->add_control(
            	'button_link_heading',[
            		...
            		'label' => esc_html__( 'Submit Button', 'spark-construction-lite' ),
                    'separator' => 'before',
            	]
            );
            ...
            $this->start_controls_tabs( 'button_style_tabs' );
                ...
                $this->start_controls_tab(
                    'button_normal_tab', [
                        'label' => __('Normal', 'spark-construction-lite'),
                    ]
                );
