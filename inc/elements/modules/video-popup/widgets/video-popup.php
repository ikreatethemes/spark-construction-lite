...
namespace SparkConstructionLiteElements\Modules\VideoPopup\Widgets;
...
class VideoPopup extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Video PopUp', 'spark-construction-lite');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'video_url', [
                'label' => esc_html__('Video URL', 'spark-construction-lite'),
                'type' => Controls_Manager::URL,
                'description' => esc_html__('To display YouTube, Vimeo or VK video, paste the video URL (https://www.youtube.com/watch?v=XzwqRZtBRDY)', 'spark-construction-lite'),
                'placeholder' => esc_html__('https://your-link.com', 'spark-construction-lite'),
                'show_external' => true,
                'default' => [
                    'url' => '',
                    'is_external' => true,
        ...
        $this->add_control(
            'icon_type', [
                'label' => esc_html__('Video Icon Type', 'spark-construction-lite'),
                'type' => Controls_Manager::SELECT,
                'label_block' => true,
                'default' => 'default',
                'options' => [
                    'default' => esc_html__('Default', 'spark-construction-lite'),
                    'icon' => esc_html__('Font & SVG Icon', 'spark-construction-lite'),
                    'image' => esc_html__('Image Icon', 'spark-construction-lite'),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'icon_font_size', [
                'label' => esc_html__('Icon Font Size', 'spark-construction-lite'),
        ...
        $this->add_responsive_control(
            'font_icon', [
                ...
                'description' => esc_html__('On clicking the video play button, the video will show in popup.', 'spark-construction-lite'),
        ...
        $this->add_responsive_control(
            'image_icon', [
                'label' => esc_html__('Select Image', 'spark-construction-lite'),
        ...
        $this->add_control(
            'default_icon_color', [
                'label' => esc_html__('Icon Color', 'spark-construction-lite'),
                'type' => Controls_Manager::COLOR,
                'default' => '#FFFFFF',
                'condition' => [
                    'icon_type' => ['default'],
        ...
        $this->add_control(
            'icon_color_hover', [
                'label' => esc_html__('Icon Color(Hover)', 'spark-construction-lite'),
                'type' => Controls_Manager::COLOR,
                'condition' => [
                    'icon_type' => ['icon'],
                ],
