...
namespace SparkConstructionLiteElements\Modules\PortfolioGallery\Widgets;
...
class PortfolioGallery extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Portfolio Gallery', 'spark-construction-lite' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'settings', [ 'label' => esc_html__( 'Settings', 'spark-construction-lite' ) ] );
			...
			$this->add_control(
				'lazyload',[
					...
					'label' => esc_html__( 'Lazy Load', 'spark-construction-lite' ),
					'return_value' => 'yes',
					'default' => 'yes',
				]
			);
			...
			$this->add_control(
				'gallery_layout',[
					...
					'options' => [
						...
						'justified' => esc_html__( 'Justified', 'spark-construction-lite' ),
						'masonry' => esc_html__( 'Masonry', 'spark-construction-lite' ),
					],
					'separator' => 'before',
				]
			);
			...
			$this->add_responsive_control(
				'columns',[
					'label' => esc_html__( 'Columns', 'spark-construction-lite' ),
			...
			$this->add_responsive_control(
				'ideal_row_height',[
					'label' => esc_html__( 'Row Height', 'spark-construction-lite' ),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'min' => 50,
			...
			$this->add_control(
				'link_to',[
					...
					'default' => 'file',
					'options' => [
						'' => esc_html__( 'None', 'spark-construction-lite' ),
						'file' => esc_html__( 'Media File', 'spark-construction-lite' ),
						'custom' => esc_html__( 'Custom URL', 'spark-construction-lite' ),
					],
				]
			);
			...
			$this->add_control(
				'url',[
					'label' => esc_html__( 'URL', 'spark-construction-lite' ),
			...
			$this->add_control(
				'open_lightbox',[
					'label' => esc_html__( 'Lightbox', 'spark-construction-lite' ),
					'type' => Controls_Manager::SELECT,
					'description' => sprintf(
						/* translators: 1: Link open tag, 2: Link close tag. */
						esc_html__( 'Manage your site’s lightbox settings in the %1$sLightbox panel%2$s.', 'spark-construction-lite' ),
					...
					'options' => [
						...
						'yes' => esc_html__( 'Yes', 'spark-construction-lite' ),
						'no' => esc_html__( 'No', 'spark-construction-lite' ),
					],
					'condition' => [
						'link_to' => 'file',
					],
			...
			$this->add_control(
				'aspect_ratio',[
					'type' => Controls_Manager::SELECT,
					'label' => esc_html__( 'Aspect Ratio', 'spark-construction-lite' ),
					'default' => '4:3',
					'options' => [
						'1:1' => '1:1',
						'3:2' => '3:2',
		...
		$this->start_controls_section(
			'section_filter_bar_content',[
				'label' => esc_html__( 'Filter Bar', 'spark-construction-lite' ),
				'condition' => [
					'gallery_type' => 'multiple',
				],
			]
			...
			$this->add_control(
				'show_all_galleries',[
					'type' => Controls_Manager::SWITCHER,
					'label' => esc_html__( '"All" Filter', 'spark-construction-lite' ),
					'default' => 'yes',
			...
			$this->add_control(
				'show_all_galleries_label',[
					...
					'default' => esc_html__( 'All', 'spark-construction-lite' ),
					'condition' => [
			...
			$this->add_control(
				'pointer',[
					'label' => esc_html__( 'Pointer', 'spark-construction-lite' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'underline',
					'options' => [
						'none' => esc_html__( 'None', 'spark-construction-lite' ),
						'underline' => esc_html__( 'Underline', 'spark-construction-lite' ),
						'overline' => esc_html__( 'Overline', 'spark-construction-lite' ),
						'double-line' => esc_html__( 'Double Line', 'spark-construction-lite' ),
						'framed' => esc_html__( 'Framed', 'spark-construction-lite' ),
						'background' => esc_html__( 'Background', 'spark-construction-lite' ),
						'text' => esc_html__( 'Text', 'spark-construction-lite' ),
					],
					'style_transfer' => true,
				]
			);
			...
			$this->add_control(
				'animation_line',[
					'label' => esc_html__( 'Animation', 'spark-construction-lite' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'fade',
					'options' => [
						'fade' => 'Fade',
		...
		$this->start_controls_section( 'overlay', [ 'label' => esc_html__( 'Overlay', 'spark-construction-lite' ) ] );
			...
			$this->add_control(
				'overlay_title',[
					...
					'options' => [
						...
						'caption' => esc_html__( 'Caption', 'spark-construction-lite' ),
						'alt' => esc_html__( 'Alt', 'spark-construction-lite' ),
						'description' => esc_html__( 'Description', 'spark-construction-lite' ),
					],
				]
			);
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						'image_border_color_hover',[
							...
							'type' => Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .sparkconstructionlite-gallery-item:hover' => 'border-color: {{VALUE}}',
							],
						]
					);
					...
					$this->add_control(
						'image_border_radius_hover',[
							...
							'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
							'selectors' => [
								'{{WRAPPER}} .sparkconstructionlite-gallery-item:hover' => 'border-radius: {{SIZE}}{{UNIT}};',
							],
						]
					);
		...
		$this->start_controls_section(
				...
				$this->start_controls_tab(
					...
					$this->add_group_control(
						Group_Control_Background::get_type(),[
							...
							'exclude' => [ 'image' ],
							'selector' => '{{WRAPPER}} .sparkconstructionlite-gallery-item-overlay',
							'fields_options' => [
								'background' => [
									'default' => 'classic',
								],
				...
				$this->start_controls_tab(
					...
					$this->add_group_control(
						Group_Control_Background::get_type(),[
							...
							'types' => [ 'classic', 'gradient' ],
							'selector' => '{{WRAPPER}} .e-gallery-item:hover .sparkconstructionlite-gallery-item-overlay, {{WRAPPER}} .e-gallery-item:focus .sparkconstructionlite-gallery-item-overlay',
							'exclude' => [ 'image' ],
							'fields_options' => [
								'background' => [
									'default' => 'classic',
			...
			$this->add_control(
            	'content_animation',[
            		...
            		'groups' => [
            			[
            				'label' => esc_html__( 'None', 'spark-construction-lite' ),
            				'options' => [
            					'' => esc_html__( 'None', 'spark-construction-lite' ),
            				],
            			],
            			[
            				'label' => esc_html__( 'Entrance', 'spark-construction-lite' ),
            				'options' => [
            			...
            			[
            				'label' => esc_html__( 'Reaction', 'spark-construction-lite' ),
            				'options' => [
            					'grow' => 'Grow',
            					'shrink' => 'Shrink',
            					'move-right' => 'Move Right',
            			...
            			[
            				'label' => esc_html__( 'Exit', 'spark-construction-lite' ),
            				'options' => [
				...
				$this->add_control(
					...
					$this->add_group_control(
						Group_Control_Typography::get_type(),[
							...
							'selector' => '{{WRAPPER}} .sparkconstructionlite-gallery-item-title',
							'condition' => [
								'overlay_title!' => '',
							],
						]
				...
				$this->add_control(
					...
					$this->add_group_control(
						Group_Control_Typography::get_type(),[
							...
							'selector' => '{{WRAPPER}} .sparkconstructionlite-gallery-item-description',
							'condition' => [
								'overlay_description!' => '',
							],
						]
	...
	protected function render() {
		...
		if ( $is_multiple ) {
			...
			$this->add_render_attribute(
				'titles-container',[
					...
					'aria-label' => esc_html__( 'Gallery filter', 'spark-construction-lite' ),
				]
			);
			...
			<div <?php $this->print_render_attribute_string( 'titles-container' ); ?>>
				...
				<?php 
					foreach ( $settings['galleries'] as $index => $gallery ) :
						...
						//$gallerytitle = preg_replace('/[^a-zA-Z0-9_-]/s','', $gallery['gallery_title'] );
					?>
		...
		$this->add_render_attribute( 'gallery_container', 'class', 'sparkconstructionlite-gallery-wrapper' );

		if ( $settings['overlay_title'] || $settings['overlay_description'] ) {

			$this->add_render_attribute( 'gallery_item_content', 'class', 'sparkconstructionlite-gallery-item-content' );
			...
			if ( $settings['overlay_title'] ) {
				$this->add_render_attribute( 'gallery_item_title', 'class', 'sparkconstructionlite-gallery-item-title' );
			}

			if ( $settings['overlay_description'] ) {
				$this->add_render_attribute( 'gallery_item_description', 'class', 'sparkconstructionlite-gallery-item-description' );
			}
		...
		$this->add_render_attribute( 'gallery_item_background_overlay', [ 'class' => 'sparkconstructionlite-gallery-item-overlay' ] );
		...
		<div <?php $this->print_render_attribute_string( 'gallery_container' ); ?> data-params='<?php echo $params; ?>'>
			...
			foreach ( $gallery_items as $id => $tags ) :
				...
				$this->add_render_attribute( 'gallery_item_' . $unique_index, [
					'class' => [
						'e-gallery-item',
						'sparkconstructionlite-gallery-item'
					],
				] );
				...
				if ( !empty( $settings['image_hover_animation'] ) ) {
					$this->add_render_attribute( 'gallery_item_' . $unique_index, [ 
						'class' => 'sparkconstructionlite-bg-transform-'.$settings['image_hover_animation'] ] 
					);
				}
				...
				$this->add_render_attribute( 'gallery_item_image_' . $unique_index,
					[
						'class' => [
							'e-gallery-image',
							'sparkconstructionlite-gallery-item-image',
							'sparkconstructionlite-bg'
						],
