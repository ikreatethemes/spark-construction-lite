...
namespace SparkConstructionLiteElements\Modules\TeamBlock\Widgets;
...
class TeamBlock extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Team Block', 'spark-construction-lite');
    }
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                'image_height', [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-team-member-img img' => 'height: {{SIZE}}{{UNIT}}; object-fit: cover;',
                    ],
                    'conditions' => [
                        'relation' => 'and',
                        'terms' => [
            ...
            $this->add_control(
                'header_member_image', [
                    'label' => esc_html__('Header Photo', 'spark-construction-lite'),
            ...
            $repeater->add_control(
                'social_icon_title', [
                    ...
                    'type' => Controls_Manager::TEXT,
                    'label_block' => true,
                    'default' => esc_html__('Social Icon', 'spark-construction-lite'),
                ]
            );
            ...
            $this->add_control(
                'social_icons_block', [
                    ...
                    'default' => [
                        [
                            'social_icon_title' => esc_html__('Facebook', 'spark-construction-lite'),
                            'social_icon' => [
                                'value' => 'fab fa-facebook-f',
                                'library' => 'solid',
                            ],
                        ...
                        [
                            'social_icon_title' => esc_html__('Twitter', 'spark-construction-lite'),
                            'social_icon' => [
                        ...
                        [
                            'social_icon_title' => esc_html__('Instagram', 'spark-construction-lite'),
                            'social_icon' => [
                        ...
                        [
                            'social_icon_title' => esc_html__('Linkedin', 'spark-construction-lite'),
                            'social_icon' => [
            ...
            $this->add_group_control(
                Group_Control_Box_Shadow::get_type(),[
                    ...
                    'selector' => '{{WRAPPER}} .sparkconstructionlite-team-member-wrapper.style1,
                                   {{WRAPPER}} .sparkconstructionlite-team-member-wrapper.style2,
                                   {{WRAPPER}} .sparkconstructionlite-team-member-wrapper.style7',
                    'condition' => [
                        'layout' => ['style1','style7']
                    ],
                ]
            ...
            <div <?php $this->print_render_attribute_string( 'buttom_content' ); ?>>
                ...
                <div class="sparkconstructionlite-team-socialicon-wrap">
                    <?php
                        ...
                        $this->add_render_attribute( "social_link_{$key}", 'class', ['sparkconstructionlite-social-item-link'] );
                    ?>
