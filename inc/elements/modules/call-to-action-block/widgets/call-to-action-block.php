...
namespace SparkConstructionLiteElements\Modules\CallToActionBlock\Widgets;
...
class CallToActionBlock extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Call To Action Block', 'spark-construction-lite');
    }
    ...
    protected function register_controls() {
		...
		$this->start_controls_section(
            ...
            $this->add_group_control(
                Group_Control_Image_Size::get_type(),[
                    'name' => 'bg_image',
                    'label' => esc_html__( 'Image Resolution', 'spark-construction-lite' ),
                    'default' => 'large',
                    'condition' => [
                        'bg_image[id]!' => '',
                    ],
            ...
            $this->add_control(
                'title',[
                    ...
                    'default' => esc_html__( 'Your CTA Heading Title', 'spark-construction-lite' ),
                    'placeholder' => esc_html__( 'Enter your title', 'spark-construction-lite' ),
                    'label_block' => true,
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_control(
                'description',[
                    ...
                    'placeholder' => esc_html__( 'Enter your description', 'spark-construction-lite' ),
                    'separator' => 'before',
                    'rows' => 5,
                ]
            );
            ...
            $this->add_control(
                'button_icon',[
                    'label' => esc_html__( 'Button Icon', 'spark-construction-lite' ),
                    'type' => Controls_Manager::ICONS,
                    'skin' => 'inline',
                    'default' => [
                        'library' => 'fa-solid',
            ...
            $this->add_control(
                'link_one',[
                    'label' => esc_html__( 'Second Button Link', 'spark-construction-lite' ),
                    'type' => Controls_Manager::URL,
                ]
            );
		...
		$this->start_controls_section(
			'section_ribbon',[
				'label' => esc_html__( 'Ribbon', 'spark-construction-lite' ),
			]
		);
		...
		$this->start_controls_section(
			'box_style',[
				'label' => esc_html__( 'General Box', 'spark-construction-lite' ),
		...
		$this->start_controls_section(
            ...
            $this->add_control(
                'icon_padding',[
                    'label' => esc_html__( 'Icon Padding', 'spark-construction-lite' ),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', 'em', 'rem', 'custom' ],
                    'selectors' => [
		...
		$this->start_controls_section(
            ...
            $this->add_control(
                'heading_content_colors',[
                    'type' => Controls_Manager::HEADING,
                    'label' => esc_html__( 'Colors', 'spark-construction-lite' ),
                    'separator' => 'before',
                ]
            );
            ...
            $this->start_controls_tabs( 'color_tabs' );
                ...
                $this->start_controls_tab( 'colors_normal',[
                    ...
                    $this->add_control(
                        'title_color',[
                            'label' => esc_html__( 'Title Color', 'spark-construction-lite' ),
                            'type' => Controls_Manager::COLOR,
                            'selectors' => [
                    ...
                    $this->add_control(
                        'description_color',[
                            'label' => esc_html__( 'Description Color', 'spark-construction-lite' ),
                            'type' => Controls_Manager::COLOR,
                            'selectors' => [
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        'secondary_text_color',[
                            ...
                            'type' => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .sparkconstructionlite-button.sparkconstructionlite-button-border, {{WRAPPER}} .sparkconstructionlite-button.sparkconstructionlite-button-border .sparkconstructionlite-link-icon svg' => 'color: {{VALUE}}; fill: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        Group_Control_Background::get_type(),[
                            ...
                            'types' => [ 'classic', 'gradient' ],
                            'exclude' => [ 'image' ],
                            'selector' => '{{WRAPPER}} .sparkconstructionlite-button.sparkconstructionlite-button-border',
                            'fields_options' => [
                                'background' => [
                                    'default' => 'classic',
                                ],
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        'secondary_hover_text_color',[
                            ...
                            'type' => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .sparkconstructionlite-button.sparkconstructionlite-button-border:hover, {{WRAPPER}} .sparkconstructionlite-button.sparkconstructionlite-button-border:hover .sparkconstructionlite-link-icon svg' => 'color: {{VALUE}}; fill: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        Group_Control_Background::get_type(),[
                            ...
                            'types' => [ 'classic', 'gradient' ],
                            'exclude' => [ 'image' ],
                            'selector' => '{{WRAPPER}} .sparkconstructionlite-button.sparkconstructionlite-button-border::before',
                            'fields_options' => [
                                'background' => [
                                    'default' => 'classic',
                                ],
                    ...
                    $this->add_group_control(
                        Group_Control_Border::get_type(),[
                            ...
                            'selector' => '{{WRAPPER}} .sparkconstructionlite-button.sparkconstructionlite-button-border:hover',
                            'default' => 'none',
                        ]
                    );
		...
		$this->start_controls_section(
            ...
            $this->add_responsive_control(
                'ribbon_distance',[
                    'label' => esc_html__( 'Distance', 'spark-construction-lite' ),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', 'em', 'rem', 'custom' ],
                    'range' => [
                        'px' => [
		...
		$this->start_controls_section(
            ...
            $this->add_control(
            	'sequenced_animation',[
            		...
            		'label_on' => esc_html__( 'On', 'spark-construction-lite' ),
            		'label_off' => esc_html__( 'Off', 'spark-construction-lite' ),
	...
	protected function render() {
		...
		$this->add_render_attribute( 'button', 'class', ['sparkconstructionlite-button','sparkconstructionlite-button-primary'] );

        $this->add_link_attributes( 'button_one', $settings['link_one'] );
		$this->add_render_attribute( 'button_one', 'class', ['sparkconstructionlite-button','sparkconstructionlite-button-border'] );
		...
		<<?php Utils::print_validated_html_tag( $wrapper_tag ); ?> <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
            ...
            <?php if ( $print_bg ) : ?>
                <div class="calltoaction-bg-wrapper">
                    <div class="calltoaction-bg-image sparkconstructionlite-bg" <?php $this->print_render_attribute_string( 'background_image' ); ?>></div>
