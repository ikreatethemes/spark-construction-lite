...
namespace SparkConstructionLiteElements\Modules\TestimonialCarousel\Widgets;
...
class TestimonialCarousel extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Testimonial Carousel', 'spark-construction-lite');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                'imageheight', [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .sparkconstructionlite-testimonial-wrapper.style3 .sparkconstructionlite-testimonial-top-content img,
                        {{WRAPPER}} .sparkconstructionlite-testimonial-wrapper.style4 .sparkconstructionlite-testimonial-top-content img, 
                ...
                'testimonial_block_items', [
                    ...
                    'default' => [
                        [
                            ...
                            'content' => esc_html__('End your search here! Unlock Our Premium Themes to launch your website. All themes are user-friendly and fully customizable.', 'spark-construction-lite'),
                        ],
                        [
                            'image' => Utils::get_placeholder_image_src(),
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'slides_to_show', [
                    'label' => esc_html__('Testimonial Items', 'spark-construction-lite'),
                    'type' => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 2,
            ...
            $this->add_control(
                'slides_margin', [
                    'label' => esc_html__('Spacing Testimonial Item', 'spark-construction-lite'),
                    'type' => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'min' => 0,
    ...
    protected function render() {
        ...
        ?>
        <div class="sparkconstructionlite-testimonial-carousel owl-carousel carouseldots" data-params='<?php echo $params; ?>'>
