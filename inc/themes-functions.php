...
if ( ! function_exists( 'sparkconstructionlite_themes_section_title' ) ) {
	/**
	 ...
	 * @return void
	 */
	function sparkconstructionlite_themes_section_title( $super_title, $title, $titlestyle, $designstyle ) {
...
if ( ! function_exists( 'sparkconstructionlite_themes_header_logo' ) ) {
	/**
	 * Display header logo
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_header_logo() {
		?>
		<div class="site-branding">
			<div class="site-brandinglogo">
				...
				<?php endif; ?>
				<?php
				$sparkconstructionlite_description = get_bloginfo( 'description', 'display' );
				if ( $sparkconstructionlite_description || is_customize_preview() ) :
					?>
					<p class="site-description"><?php echo esc_html( $sparkconstructionlite_description ); ?></p>
				<?php endif; ?>
			</div>
			<button class="header-nav-toggle" data-toggle-target=".header-mobile-menu" data-toggle-body-class="showing-menu-modal" aria-expanded="false" data-set-focus=".close-nav-toggle">
				<div class="sparkconstructionlite-menu-modal">
					<span class="sparkconstructionlite-icon-bar"></span>
					<span class="sparkconstructionlite-icon-bar"></span>
					<span class="sparkconstructionlite-icon-bar"></span>
				</div>
			</button>
...
if ( ! function_exists( 'sparkconstructionlite_themes_home_post_meta' ) ) {
	/**
	 * Display home post meta
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_home_post_meta() {

		$postauthor = get_theme_mod( 'sparkconstructionlite_home_post_author_options', 'enable' );
		$date       = get_theme_mod( 'sparkconstructionlite_home_post_date_options', 'enable' );
		$read_time  = get_theme_mod( 'sparkconstructionlite_home_post_reading_time', 'enable' );
		...
		if ( 'enable' === $date || 'enable' === $postauthor || 'enable' === $read_time ) :
			...
			<div class="entry-meta info">
				...
				if ( ! empty( $postauthor ) && 'enable' === $postauthor ) {
					sparkconstructionlite_themes_posted_by();
				}
				if ( ! empty( $date ) && 'enable' === $date ) {
					sparkconstructionlite_themes_posted_on();
				}
				if ( ! empty( $read_time ) && 'enable' === $read_time ) {
					echo wp_kses_post( sparkconstructionlite_themes_estimated_reading_time() );
				}
				?>
			</div>
			<?php
...
add_action( 'sparkconstructionlite_themes_home_post_meta', 'sparkconstructionlite_themes_home_post_meta', 10 );

if ( ! function_exists( 'sparkconstructionlite_themes_post_meta' ) ) {
	/**
	 * Display post meta
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_post_meta() {

		$postdate    = get_theme_mod( 'sparkconstructionlite_post_date_options', 'enable' );
		$postcomment = get_theme_mod( 'sparkconstructionlite_post_comments_options', 'enable' );
		$postauthor  = get_theme_mod( 'sparkconstructionlite_post_author_options', 'enable' );
		$read_time   = get_theme_mod( 'sparkconstructionlite_post_reading_time', 'enable' );
			...
			<div class="entry-meta info">
				...
				if ( is_singular() ) {
					if ( ! empty( $postcomment ) && 'enable' === $postcomment ) {
						sparkconstructionlite_themes_comments();
					}
				}
...
add_action( 'sparkconstructionlite_themes_post_meta', 'sparkconstructionlite_themes_post_meta', 10 );

if ( ! function_exists( 'sparkconstructionlite_themes_post_format_media' ) ) {
	/**
	 * Display post format media
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_post_format_media() {
...
if ( ! function_exists( 'sparkconstructionlite_themes_top_footer_content' ) ) {
	/**
	 * Display top footer content
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_top_footer_content() {
		?>
		<footer id="footer-section" class="footer-section section site-footer">
			<div class="container">
				<div class="d-grid <?php echo esc_attr( get_theme_mod( 'sparkconstructionlite_footer_column', 'd-grid-column-3' ) ); ?>">
					<?php
					for ( $i = 1; $i <= 4; $i++ ) {
...
add_action( 'sparkconstructionlite_themes_top_footer_content', 'sparkconstructionlite_themes_top_footer_content' );

if ( ! function_exists( 'sparkconstructionlite_themes_footer_copyright' ) ) {
	/**
	 * Display footer copyright
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_footer_copyright() {

		echo esc_html(
			apply_filters(
				'sparkconstructionlite_themes_footer_copy_right',
				$content = esc_html__( '&copy; Copyright ', 'spark-construction-lite' ) . date_i18n( 'Y' ) . ' '
			)
		);
		printf(
			/* translators: %s: Developer link */
			esc_html__( 'All Rights Reserved. Developed by %s', 'spark-construction-lite' ),
			'<a href="' . esc_url( 'https://ikreatethemes.com/' ) . '" rel="designer" target="_blank">' . esc_html__( 'Ikreate Themes', 'spark-construction-lite' ) . '</a>'
		);
	}
}
add_action( 'sparkconstructionlite_themes_copyright', 'sparkconstructionlite_themes_footer_copyright', 5 );

if ( ! function_exists( 'sparkconstructionlite_themes_nav_buttons' ) ) {
	/**
	 * Display navigation buttons
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_nav_buttons() {
		?>
		<div class="nav-buttons">
			<?php if ( 'enable' === get_theme_mod( 'sparkconstructionlite_enable_search', 'enable' ) ) { ?>
			...
			<?php if ( 'enable' === get_theme_mod( 'sparkconstructionlite_header_button_enable', 'enable' ) ) { ?>
...
add_action( 'sparkconstructionlite_themes_nav_buttons', 'sparkconstructionlite_themes_nav_buttons' );
 ...
 * @return void
 */
function sparkconstructionlite_themes_admin_editor_style() {
...
add_action( 'admin_init', 'sparkconstructionlite_themes_admin_editor_style' );

if ( ! function_exists( 'sparkconstructionlite_themes_contact_info_section' ) ) {
	/**
	 * Display contact info section
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_contact_info_section() {

		$details = get_theme_mod( 'sparkconstructionlite_contact_details' );
...
add_action( 'sparkconstructionlite_themes_contact_info_section', 'sparkconstructionlite_themes_contact_info_section' );

if ( ! function_exists( 'sparkconstructionlite_themes_quick_contact' ) ) :
	/**
	 * Display quick contact info
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_quick_contact() {
		?>
		<ul class="sparkconstructionlite-quick-info">
			<?php
				...
				wp_json_encode(
					array(
						...
						array(
							...
							'label'  => esc_html__( 'eMail :', 'spark-construction-lite' ),
							'val'    => 'example@example.com',
							'enable' => 'enable',
						),
						array(
							'icon'   => 'fas fa-map-marker-alt',
							'label'  => esc_html__( 'Address :', 'spark-construction-lite' ),
...
if ( ! function_exists( 'sparkconstructionlite_themes_quick_contact_info_header' ) ) :
	/**
	 * Display quick contact info in header
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_quick_contact_info_header() {
		?>
		<div class="sparkconstructionlite-quick-contact">
			<?php
			$quick_content = get_theme_mod(
				...
				wp_json_encode(
					array(
						array(
							'icon'   => 'fa-regular fa-envelope-open',
							'label'  => esc_html__( 'Quick Questions? Email Us', 'spark-construction-lite' ),
							'val'    => 'example@example.com',
							'enable' => 'enable',
						),
						array(
							'icon'   => 'fa-solid fa-headset',
							'label'  => esc_html__( 'Talk to an Expert (Aradia)', 'spark-construction-lite' ),
							'val'    => '(555)-555-5555',
							'enable' => 'enable',
						),
						array(
							'icon'   => 'fas fa-map-marker-alt',
							'label'  => esc_html__( 'Office Address', 'spark-construction-lite' ),
							'val'    => '123 Main Street, Springfield, USA',
							'enable' => 'enable',
						),
					)
			...
			if ( is_array( $quick_content ) ) {
				foreach ( $quick_content as $index => $quick ) {
					...
					?>
					<div class="sparkconstructionlite-contact-item">                                    
						<div class="sparkconstructionlite-contact-wrap">
							<?php if ( filter_var( $quick->val, FILTER_VALIDATE_EMAIL ) ) { ?>
								<a href="mailto:<?php echo esc_attr( $quick->val ); ?>">
									<div class="sparkconstructionlite-contact-value">
										<?php echo esc_html( $quick->val ); ?>
									</div>
								</a>
								<div class="sparkconstructionlite-contact-title">
							...
							<?php } elseif ( preg_match( '/^\+?[0-9\-\(\)\s]+$/', $quick->val ) && 1 === $index ) { ?>
								...
								<div class="sparkconstructionlite-contact-value">
									<a href="https://wa.me/<?php echo esc_attr( preg_replace( '/\D+/', '', $quick->val ) ); ?>?text=Hi" target="_blank" aria-label="<?php esc_attr_e( 'WhatsApp', 'spark-construction-lite' ); ?>">
						...
						<?php if ( ! empty( $quick->icon ) ) : ?>
							<div class="sparkconstructionlite-contact-icon">
								<i class="<?php echo esc_attr( $quick->icon ); ?>"></i>
							</div>
						<?php endif; ?>
					</div>
...
add_action( 'sparkconstructionlite_themes_quick_contact_info_header', 'sparkconstructionlite_themes_quick_contact_info_header' );

if ( ! function_exists( 'sparkconstructionlite_themes_topheader_social' ) ) :
	/**
	 * Display top header social icons
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_topheader_social() {
		...
		echo '<ul class="sparkconstructionlite-socialicon">';
...
add_action( 'sparkconstructionlite_themes_social_icons', 'sparkconstructionlite_themes_topheader_social' );

if ( ! function_exists( 'sparkconstructionlite_themes_header_button' ) ) {
	/**
	 * Display header button
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_header_button() {

		$ikbutton        = get_theme_mod( 'sparkconstructionlite_header_button_enable', 'enable' );
		$ikbutton_title  = get_theme_mod( 'sparkconstructionlite_hb_title', 'Book Now' );
		$ikbutton_text   = get_theme_mod( 'sparkconstructionlite_hb_text', '(555)-555-5555' );
		$ikbutton_icon   = get_theme_mod( 'sparkconstructionlite_hb_icon', 'fa-solid fa-headset' );
		$ikbutton_link   = get_theme_mod( 'sparkconstructionlite_hb_link', '#' );
		$ikbutton_style  = get_theme_mod( 'sparkconstructionlite_button_style', 'disable' );
...
add_action( 'sparkconstructionlite_themes_header_button', 'sparkconstructionlite_themes_header_button' );

if ( ! function_exists( 'sparkconstructionlite_themes_topheader_free_hand' ) ) :
	/**
	 * Display top header free hand content
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_topheader_free_hand() {

		$free_hand = get_theme_mod( 'sparkconstructionlite_topheader_free_hand', 'Need Any Help: <b>+1-555-555-5555 or example@example.com</b>' );
		?>
...
if ( ! function_exists( 'sparkconstructionlite_themes_breadcrumbs' ) ) :
	/**
	 * Display breadcrumbs
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_breadcrumbs() {
		$service_class = array(
			'titlebar-section',
			'section',
			get_theme_mod( 'sparkconstructionlite_titlebar_title_align', 'text-left' ),
		);
		?>
			<div class="breadcrumb-section">
					...
					<div class="section-wrap">
						<div class="container">
							<div class="inner-section-wrap breadcrumb_wrapper">
								<?php
								if ( get_theme_mod( 'sparkconstructionlite_show_title', true ) ) :
									...
									elseif ( is_search() ) :
										...
										<h2 class="section-title">
											...
											printf(
												...
												esc_html__( 'Search Results for: %s', 'spark-construction-lite' ),
												'<span>' . get_search_query() . '</span>'
											);
											?>
										</h2>
									<?php elseif ( is_404() ) : ?>
										<h2 class="section-title"><?php esc_html_e( '404 Error', 'spark-construction-lite' ); ?></h2>
									<?php elseif ( is_home() ) : ?>
										<?php
								...
								if ( get_theme_mod( 'sparkconstructionlite_breadcrumb', true ) ) :
									?>
				...
				<div class="breadcrumb-seprator">
					<?php sparkconstructionlite_themes_add_bottom_seperator( 'titlebar' ); ?> 
				</div>
			</div>
		<?php
	}
endif;
add_action( 'sparkconstructionlite_themes_breadcrumbs', 'sparkconstructionlite_themes_breadcrumbs', 100 );

if ( ! function_exists( 'sparkconstructionlite_themes_banner_slider' ) ) :
	/**
	 * Display banner slider
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_banner_slider() {

		$all_slider = get_theme_mod( 'sparkconstructionlite_banner_sliders' );
		...
		if ( ! empty( $banner_slider ) ) {
			...
			$data = sparkconstructionlite_themes_get_data_attribute( $controls );

			$bg_overlay_color = get_theme_mod( 'sparkconstructionlite_banner_overlay_color', 'rgba(0, 0, 0, 0.35)' );

			$slider_class = array( 'sparkconstructionlite-banner-slide', 'owl-carousel', $controls['navstyle'], $controls['dotstyle'] );

			?>
			<div class="sparkconstructionlite-banner-wrapper">
								...
								while ( $slider_page->have_posts() ) {
									...
									<div class="sparkconstructionlite-slider-item-wrap">
										...
										<div class="sparkconstructionlite-banner-caption">
												...
												<h2 class="sparkconstructionlite-banner-title"><?php the_title(); ?></h2>
												<div class="sparkconstructionlite-banner-content"><?php the_excerpt(); ?></div>
												<div class="sparkconstructionlite-banner-btn-wrap">
...
add_action( 'sparkconstructionlite_themes_action_banner_slider', 'sparkconstructionlite_themes_banner_slider', 5 );

if ( ! function_exists( 'sparkconstructionlite_themes_advance_banner_slider' ) ) :
	/**
	 * Display advance banner slider
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_advance_banner_slider() {

		$all_slider = get_theme_mod( 'sparkconstructionlite_slider_advance_settings' );
							...
							<div class="sparkconstructionlite-banner-caption-wrap <?php echo esc_attr( $slider->alignment ); ?>" style="justify-content:<?php echo esc_attr( $slider->alignment ); ?>">
								<div class="sparkconstructionlite-banner-caption">
									<?php if ( ! empty( $slider->block_subtitile ) ) : ?>
										<h3 class="sparkconstructionlite-banner-supertitle"><?php echo esc_html( $slider->block_subtitile ); ?></h3>
									<?php endif; ?>

									<?php if ( ! empty( $slider->block_title ) ) : ?>
										<h2 class="sparkconstructionlite-banner-title"><?php echo esc_html( $slider->block_title ); ?></h2>
									<?php endif; ?>

									<?php if ( ! empty( $slider->block_desc ) ) : ?>
										<div class="sparkconstructionlite-banner-content"><?php echo esc_html( $slider->block_desc ); ?></div>
									<?php endif; ?>
...
add_action( 'sparkconstructionlite_themes_advance_slider', 'sparkconstructionlite_themes_advance_banner_slider', 10 );

if ( ! function_exists( 'sparkconstructionlite_themes_all_slider_type' ) ) :
	/**
	 * Display all slider types
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_all_slider_type() {

		$slider_type = get_theme_mod( 'sparkconstructionlite_slider_type', 'default' );

		switch ( $slider_type ) {
			case 'advance':
				do_action( 'sparkconstructionlite_themes_advance_slider' );
				break;

			default:
				do_action( 'sparkconstructionlite_themes_action_banner_slider' );
				break;
		}
	}
endif;
add_action( 'sparkconstructionlite_themes_slider_type', 'sparkconstructionlite_themes_all_slider_type', 25 );

if ( ! function_exists( 'sparkconstructionlite_themes_add_slider_bottom_section_seperator' ) ) {
	/**
	 * Add slider bottom section separator
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_add_slider_bottom_section_seperator() {

		if ( 'bottom' === get_theme_mod( 'sparkconstructionlite_slider_section_seperator', 'no' ) ) {
			$bottom_seperator = get_theme_mod( 'sparkconstructionlite_slider_bottom_seperator', 'curv-8' );
			?>
...
add_action( 'after_slider_section', 'sparkconstructionlite_themes_add_slider_bottom_section_seperator' );

if ( ! function_exists( 'sparkconstructionlite_themes_add_footer_seperator' ) ) {
	/**
	 * Add footer separator
	 *
	 * @return void
	 */
	function sparkconstructionlite_themes_add_footer_seperator() {

		if ( 'top' === get_theme_mod( 'sparkconstructionlite_footer_section_seperator', 'no' ) ) {
			$footer_top_seperator = get_theme_mod( 'sparkconstructionlite_footer_top_seperator', 'curv-8' );
			?>
...
if ( ! function_exists( 'sparkconstructionlite_themes_add_top_seperator' ) ) :
	/**
	 * Add top separator
	 *
	 ...
	 * @return void
	 */
	function sparkconstructionlite_themes_add_top_seperator( $section_name ) {

		$section_seperator = get_theme_mod( 'sparkconstructionlite_' . $section_name . '_section_seperator', 'no' );

		if ( 'top' === $section_seperator || 'top-bottom' === $section_seperator ) {
			$top_seperator = get_theme_mod( 'sparkconstructionlite_' . $section_name . '_top_seperator', 'curv-9' );
			?>
...
if ( ! function_exists( 'sparkconstructionlite_themes_add_bottom_seperator' ) ) :
	/**
	 ...
	 * @return void
	 */
	function sparkconstructionlite_themes_add_bottom_seperator( $section_name ) {

		$section_seperator = get_theme_mod( 'sparkconstructionlite_' . $section_name . '_section_seperator', 'bottom' );

		if ( 'bottom' === $section_seperator || 'top-bottom' === $section_seperator ) {
			$bottom_seperator = get_theme_mod( 'sparkconstructionlite_' . $section_name . '_bottom_seperator', 'curv-9' );
			?>
			<div class="section-seperator bottom-section-seperator svg-<?php echo esc_attr( $bottom_seperator ); ?>-wrap">
				<?php get_template_part( 'inc/svg/' . $bottom_seperator ); ?>
			</div>
...
if ( ! function_exists( 'sparkconstructionlite_themes_alignment_class' ) ) {
	/**
	 * Get alignment class
	 *
	 ...
	 * @return string
	 */
	function sparkconstructionlite_themes_alignment_class( $align ) {
		if ( $align ) {
...
if ( ! function_exists( 'sparkconstructionlite_themes_get_data_attribute' ) ) {
	/**
	 * Get data attribute
	 *
	 ...
	 * @return string
	 */
	function sparkconstructionlite_themes_get_data_attribute( $controls ) {
		$data = '';
...
if ( ! function_exists( 'sparkconstructionlite_themes_post_category' ) ) {
	/**
	 * Get post categories
	 *
	 * @return array
	 */
	function sparkconstructionlite_themes_post_category() {
...
if (!function_exists('sparkconstructionlite_themes_svg_seperator')) {
    function sparkconstructionlite_themes_svg_seperator() {
        return array(
            'big-triangle-center' 	=> esc_html__('Big Triangle Center', 'spark-construction-lite'),
            'big-triangle-left' 	=> esc_html__('Big Triangle Left', 'spark-construction-lite'),
            'big-triangle-right' 	=> esc_html__('Big Triangle Right', 'spark-construction-lite'),
            'clouds' 				=> esc_html__('Clouds', 'spark-construction-lite'),
            'droplets' 				=> esc_html__('Droplets', 'spark-construction-lite'),
            'paper-cut' 			=> esc_html__('Paint Brush', 'spark-construction-lite'),
            'big-waves'     		=> esc_html__('Big Waves', 'spark-construction-lite'),
            'slanted-waves' 		=> esc_html__('Slanted Waves', 'spark-construction-lite'),
            'curv-3'        		=> esc_html__('Curv 3', 'spark-construction-lite'),
            'curv-4'        		=> esc_html__('Curv 4', 'spark-construction-lite'),
            'curv-5'        		=> esc_html__('Curv 5', 'spark-construction-lite'),
            'curv-6'        		=> esc_html__('Curv 6', 'spark-construction-lite'),
            'curv-7'        		=> esc_html__('Curv 7', 'spark-construction-lite'),
            'curv-8'        		=> esc_html__('Curv 8', 'spark-construction-lite'),
            'curv-9'        		=> esc_html__('Curv 9', 'spark-construction-lite'),
            'curv-10'        		=> esc_html__('Curv 10', 'spark-construction-lite'),
            'curv-11'        		=> esc_html__('Curv 11', 'spark-construction-lite'),
            'curv-12'        		=> esc_html__('Curv 12', 'spark-construction-lite'),
        );
    }
}

/**
 * (Social Icon ) Font Awesome Icon
 */
if(!function_exists('sparkconstructionlite_font_awesome_social_icon_array') ){
	function sparkconstructionlite_font_awesome_social_icon_array(){
 ...
 * Font Awesome Icon
 */
if (!function_exists('sparkconstructionlite_font_awesome_icon_array')) {
    function sparkconstructionlite_font_awesome_icon_array() {
 ...
 * IconFont Icon Set
*/
if (!function_exists('sparkconstructionlite_icofont_icon_array')) {
    function sparkconstructionlite_icofont_icon_array() {
