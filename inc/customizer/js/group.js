	...
	$(document).ready(
		function () {
			...
			function refresh_group_values(control_wrap) {
				...
				control_wrap.next('.sparkconstructionlite-group-collection').val(JSON.stringify(valueToPush)).trigger('change');
			}
			...
			customize_theme_controls.on(
				...
				function () {
					...
					group_field_control.find('.group-fields').trigger('sparkconstructionlite__group_slide_toggle');
				}
			);
			...
			function sparkconstructionlite__group_field_border_style_control(group_field) {
			...
			function sparkconstructionlite__group_field_check_overlay_color_control(group_field) {
			...
			customize_theme_controls.on(
				...
				function () {
					sparkconstructionlite__group_field_border_style_control($(this))
				}
			);
			...
			customize_theme_controls.on(
				...
				function () {
					sparkconstructionlite__group_field_check_overlay_color_control($(this))
				}
			);
			...
			customize_theme_controls.on(
				'click',
				'.sparkconstructionlite-image-upload',
				function (e) {
			...
			customize_theme_controls.on(
				'click',
				'.sparkconstructionlite-image-remove',
				function (e) {
...
function SparkConstructionLite_Alpha_Color_Control(wrap, $) {

	wrap.find('.sparkconstructionlite-alpha-picker').each(
...
jQuery(document).ready(
	function ($) {
		SparkConstructionLite_Alpha_Color_Control($('body'), $);
	}
);