...
if (class_exists('WP_Customize_Control')) {
     ...
     * Alpha Color Control
    */
    class SparkConstructionLite_Alpha_Color_Control extends WP_Customize_Control {
        /**
     ...
     * Buttonset control
    */
    class SparkConstructionLite_Custom_Control_Buttonset extends WP_Customize_Control {
        /**
         * The control type.
         *
         * @access public
         * @var string
         */
        public $type = 'sparkconstructionlite-buttonset';
	...
	*/
	class SparkConstructionLite_Custom_Control_Responsive_Buttonset extends WP_Customize_Control {
		/**
		* The control type.
		*
		* @access public
		* @var string
		*/
		public $type = 'sparkconstructionlite-responsive-buttonset';
		/**
		...
		*/
		...
		public function render_content() {
			...
			?>
			<ul class="sparkconstructionlite-responsive-buttonset-field-control-wrap">
				<?php $this->sparkconstructionlite_responsive_buttonset_fields(); ?>
			</ul>
			<input type="hidden" <?php $this->link(); ?> class="sparkconstructionlite-responsive-buttonset-collection-value" value="<?php echo esc_attr( $values ); ?>"/>
			<?php
		}

		public function sparkconstructionlite_responsive_buttonset_fields() {
			$devices = array(
				'desktop' => array(
			...
			?>
			<li class="sparkconstructionlite-responsive-buttonset-field-control">
				<div class="sparkconstructionlite-responsive-buttonset-fields">
					<div class="sparkconstructionlite-responsive-buttonset-title-wrap">
						<h3 class="sparkconstructionlite-responsive-buttonset-field-label">
							<?php echo "<span class='sparkconstructionlite-responsive-buttonset-field-title'>" . esc_html( $this->label ) . '</span>'; ?>
						</h3>
				...
				<div class="responsive-switchers-fields">
					<?php
						...
						foreach ( $devices as $device_id => $device_details ) {
							...
							echo '<ul class="sparkconstructionlite-responsive-buttonset-device-wrap control-wrap ' . $device_id . ' ' . $active . '" data-device="' . esc_attr( $device_id ) . '" data-inputname="' . esc_attr( $this->id . $device_id ) . '">';
    ...
    */
    class SparkConstructionLite_Fontawesome_Icon_Chooser extends WP_Customize_Control {
        ...
        public function render_content() { ?>
            <label>
                ...
                <?php } ?>
                <div class="sparkconstructionlite-customizer-icon-box">
                    <div class="sparkconstructionlite-selected-icon">
                        <i class="<?php echo esc_attr($this->value()); ?>"></i>
                        <span><i class="dashicons dashicons-arrow-down-alt2"></i></span>
                    </div>

                    <div class="sparkconstructionlite-icon-box">
                        <div class="sparkconstructionlite-icon-search">
                            <input type="text" class="sparkconstructionlite-icon-search-input" placeholder="<?php echo esc_attr__('Type to filter', 'spark-construction-lite'); ?>" />
                        </div>

                        <ul class="sparkconstructionlite-icon-list fontawesome-list clearfix active">
                            <?php
                                if (isset($this->icon_array) && !empty($this->icon_array)) {

                                    $sparkconstructionlite_font_awesome_icon_array = $this->icon_array;

                                } else {

                                    $sparkconstructionlite_font_awesome_icon_array = sparkconstructionlite_font_awesome_icon_array();

                                }
                                foreach ($sparkconstructionlite_font_awesome_icon_array as $sparkconstructionlite_font_awesome_icon) {

                                    $icon_class = $this->value() == $sparkconstructionlite_font_awesome_icon ? 'icon-active' : '';
                                    
                                    echo '<li class=' . esc_attr($icon_class) . '><i class="' . esc_attr($sparkconstructionlite_font_awesome_icon) . '"></i></li>';
                                }
                            ?>
                        </ul>
                    </div>
    ...
    */
    class SparkConstructionLite_Customize_Heading extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            if (!empty($this->label)) : ?>
                ...
                <h3 class="sparkconstructionlite-accordion-section-title">
                    <?php echo esc_html($this->label); ?>
                </h3>
     ...
     * Info Text Control
    */
    class SparkConstructionLite_Info_Text extends WP_Customize_Control {
     ...
     */
    class SparkConstructionLite_Multiple_Check_Control extends WP_Customize_Control {
     ...
     * Checkbox Control
    */
    class SparkConstructionLite_Checkbox_Control extends WP_Customize_Control {
        /**
         * Control type
         *
         * @var string
     ...
     * Select Box Control
    */
    class SparkConstructionLite_Selector extends WP_Customize_Control {
     ...
     * Separator Control
    */
    class SparkConstructionLite_Separator_Control extends WP_Customize_Control {
        /**
         * Control type
         *
         * @var string
     ...
     * Sortable Control
    */
    class SparkConstructionLite_Sortable_Control extends WP_Customize_Control {
        /**
         * The control type.
         *
         * @access public
        ...
        */
        ...
        protected function content_template() {
            ?>
            <div class='sparkconstructionlite-sortable'>
                <span class="customize-control-title">
                    {{{ data.label }}}
                </span>
                ...
                <ul class="sortable">
                    <# _.each( data.value, function( choiceID ) { #>
                        <li {{{ data.inputAttrs }}} class='sparkconstructionlite-sortable-item' data-value='{{ choiceID }}'>
                    ...
                    <# _.each( data.choices, function( choiceLabel, choiceID ) { #>
                        <# if ( -1 === data.value.indexOf( choiceID ) ) { #>
                            <li {{{ data.inputAttrs }}} class='sparkconstructionlite-sortable-item invisible' data-value='{{ choiceID }}'>
                                <i class='dashicons dashicons-menu'></i>
                                <i class="dashicons dashicons-visibility visibility"></i>
                                {{{ data.choices[ choiceID ] }}}
                            </li>
     ...
     * Switch Control
    */
    class SparkConstructionLite_Switch_Control extends WP_Customize_Control {
     ...
     * Tab Control
    */
    class SparkConstructionLite_Custom_Control_Tab extends WP_Customize_Control {
     ...
     * Toggle Eye
    */
    class SparkConstructionLite_Toggle_Section extends WP_Customize_Section {
        /**
        ...
        /**
         * SparkConstructionLite_Toggle_Section constructor.
         *
        ...
        public function enqueue() {
            wp_enqueue_script('toggle-section', get_template_directory_uri() . '/inc/customizer/js/toggle-section.js', array('jquery'), CONSTRUCTIONLITE_VERSION, true);
        }
        ...
        protected function render_template() {
            ...
            <li id="accordion-section-{{ data.id }}" class="accordion-section control-section control-section-{{ data.type }}">
                <h3 class="accordion-section-title">
                    ...
                    <span class="sparkconstructionlite--sortable-handle dashicons dashicons-image-flip-vertical"></span>
                    <# } #>    
                    <button type="button" class="accordion-trigger" aria-expanded="false" aria-controls="{{ data.id }}-content">
                    {{ data.title }}
                    <# if ( data.hide == 'enable' ) { #>
                    <a data-control="{{ data.hiding_control }}" class="sparkconstructionlite-toggle-section" href="#"><span class="dashicons dashicons-visibility"></span></a>
                    <# } else { #>
                    <a data-control="{{ data.hiding_control }}" class="sparkconstructionlite-toggle-section" href="#"><span class="dashicons dashicons-hidden"></span></a>
                    <# } #>
                    </button>
                </h3>
    ...
    */
    class SparkConstructionLite_Range_Slider_Control extends WP_Customize_Control {
        ...
        protected function content_template() {
            ...
            <# if ( data.desktop ) { #>
                <div class="desktop control-wrap active">
                    <div class="sparkconstructionlite-slider desktop-slider"></div>
                    <div class="sparkconstructionlite-slider-input">
            ...
            <# if ( data.tablet ) { #>
                <div class="tablet control-wrap">
                    <div class="sparkconstructionlite-slider tablet-slider"></div>
                    <div class="sparkconstructionlite-slider-input">
            ...
            <# if ( data.mobile ) { #>
                <div class="mobile control-wrap">
                    <div class="sparkconstructionlite-slider mobile-slider"></div>
                    <div class="sparkconstructionlite-slider-input">
     ...
     * Slider Control
     */
    class SparkConstructionLite_Themes_Range_Control extends WP_Customize_Control {
        /**
        ...
        public function render_content() { ?>
            ...
            <div class="control-wrap"> 
                <div class="sparkconstructionlite-slider" slider-min-value="<?php echo esc_attr($this->input_attrs['min']); ?>" slider-max-value="<?php echo esc_attr($this->input_attrs['max']); ?>" slider-step-value="<?php echo esc_attr($this->input_attrs['step']); ?>"></div>
                <div class="sparkconstructionlite-slider-input">
	 ...
	 * Buttonset control
	*/
	class SparkConstructionLite_Themes_Custom_Control_Cssbox extends WP_Customize_Control {
		/**
		 * The control type.
		 *
		 * @access public
		 * @var string
		 */
		public $type = 'sparkconstructionlite-cssbox';
		...
		public function get_fields() {
			...
			$link_text = isset( $attr['link_text'] ) ? $attr['link_text'] : esc_html__( 'Link', 'spark-construction-lite' );
			?>
     ...
     * Background Control
    */
    class SparkConstructionLite_Background_Control extends WP_Customize_Upload_Control {
        /**
        ...
        public function __construct($manager, $id, $args = array()) {
            ...
            $button_labels = $this->sparkconstructionlite_themes_button_labels();
            $this->button_labels = apply_filters('customizer_background_button_labels', $button_labels, $id);
            // Set field labels
            $field_labels = $this->sparkconstructionlite_themes_field_labels();
            $this->field_labels = apply_filters('customizer_background_field_labels', $field_labels, $id);
            // Set background choices
            $background_choices = $this->sparkconstructionlite_themes_background_choices();
         ...
         * @since 1.1.0
         */
        public static function sparkconstructionlite_themes_button_labels() {
            $button_labels = array(
                'select' => esc_html__('Select Image', 'spark-construction-lite'),
                'change' => esc_html__('Change Image', 'spark-construction-lite'),
                'remove' => esc_html__('Remove', 'spark-construction-lite'),
                'default' => esc_html__('Default', 'spark-construction-lite'),
                'placeholder' => esc_html__('No image selected', 'spark-construction-lite'),
                'frame_title' => esc_html__('Select Image', 'spark-construction-lite'),
                'frame_button' => esc_html__('Choose Image', 'spark-construction-lite'),
            );
         ...
         * @since 1.1.0
         */
        public static function sparkconstructionlite_themes_field_labels() {
            $field_labels = array(
                'repeat' => esc_html__('Repeat', 'spark-construction-lite'),
                'size' => esc_html__('Size', 'spark-construction-lite'),
                'position' => esc_html__('Position', 'spark-construction-lite'),
                'attach' => esc_html__('Attachment', 'spark-construction-lite')
            );
            return $field_labels;
        }
         ...
         * @return array
         */
        public static function sparkconstructionlite_themes_background_choices() {
            $choices = array(
                'repeat' => array(
                    'no-repeat' => esc_html__('No Repeat', 'spark-construction-lite'),
                    'repeat' => esc_html__('Tile', 'spark-construction-lite'),
                    'repeat-x' => esc_html__('Tile Horizontally', 'spark-construction-lite'),
                    'repeat-y' => esc_html__('Tile Vertically', 'spark-construction-lite')
                ),
                'size' => array(
                    'auto' => esc_html__('Default', 'spark-construction-lite'),
                    'cover' => esc_html__('Cover', 'spark-construction-lite'),
                    'contain' => esc_html__('Contain', 'spark-construction-lite')
                ),
                'position' => array(
                    'left top' => esc_html__('Left Top', 'spark-construction-lite'),
                    'left center' => esc_html__('Left Center', 'spark-construction-lite'),
                    'left bottom' => esc_html__('Left Bottom', 'spark-construction-lite'),
                    'right top' => esc_html__('Right Top', 'spark-construction-lite'),
                    'right center' => esc_html__('Right Center', 'spark-construction-lite'),
                    'right bottom' => esc_html__('Right Bottom', 'spark-construction-lite'),
                    'center top' => esc_html__('Center Top', 'spark-construction-lite'),
                    'center center' => esc_html__('Center Center', 'spark-construction-lite'),
                    'center bottom' => esc_html__('Center Bottom', 'spark-construction-lite')
                ),
                'attach' => array(
                    'fixed' => esc_html__('Fixed', 'spark-construction-lite'),
                    'scroll' => esc_html__('Scroll', 'spark-construction-lite')
                )
            );
            return $choices;
        }
	 ...
	 * Group Control
	*/
	class SparkConstructionLite_Themes_Custom_Control_Group extends WP_Customize_Control {
		/**
		 * The control type.
		 *
		 * @access public
		 ...
		 */
		public function enqueue() {
            wp_enqueue_script('sparkconstructionlite-group-control', get_template_directory_uri().'/inc/customizer/js/group.js', array( 'jquery', 'customize-controls' ), CONSTRUCTIONLITE_VERSION, true);
		}
		...
		public function render_content() {
			...
			?>
                ...
                <input type="hidden" <?php $this->link(); ?> class="sparkconstructionlite-group-collection" value="<?php echo esc_attr( $values ); ?>"/>
				...
				<div class="group-fields hidden">
					...
					?>
						<div class="single-field type-<?php echo esc_attr( $field['type'] ) . ' ' . $class; ?>">
							<?php
                                ...
                                switch ( $field['type'] ) {
                                    case 'color':
                                        echo '<div class="customize-control-alpha-color" data-color-single-name="' . esc_attr( $key ) . '"><input class="sparkconstructionlite-alpha-picker" data-alpha-enabled="true" data-default-color="' . esc_attr( $default ) . '" data-default="' . esc_attr( $default ) . '" data-single-name="' . esc_attr( $key ) . '" type="text" value="' . esc_attr( $new_value ) . '"/></div>';
                                        break;
                                    case 'text':
                                    ...
                                    case 'icons':
                                        ...
                                        <span class="customize-icons">
                                            <?php
                                                sparkconstructionlite_icon_holder( $new_value );
                                                echo '<input class="sparkconstructionlite-icon-value"  data-default="' . esc_attr( $default ) . '" data-single-name="' . esc_attr( $key ) . '" type="hidden" value="' . esc_attr( $new_value ) . '"/>';
                                            ?>
                                        </span>
                                        <?php
                                        break;
                                    case 'cssbox':
                                        ...
                                        break;
                                    case 'image':
                                        $sparkconstructionlite_display_none = '';
                                        if ( empty( $new_value ) ) {
                                            $sparkconstructionlite_display_none = ' style="display:none;" ';
                                        }
                                        ...
                                        ?>
                                        <span class="img-preview-wrap" <?php echo  $sparkconstructionlite_display_none; ?>>
                                            <img class="widefat" src="<?php echo esc_url( $new_value ); ?>" alt="<?php esc_attr_e( 'Image preview', 'spark-construction-lite' ); ?>"  />
                                        </span><!-- .img-preview-wrap -->
                                        <input type="button" value="<?php esc_attr_e( 'Upload Image', 'spark-construction-lite' ); ?>" class="button sparkconstructionlite-image-upload" data-title="<?php esc_attr_e( 'Select Image', 'spark-construction-lite' ); ?>" data-button="<?php esc_attr_e( 'Select Image', 'spark-construction-lite' ); ?>"/>
                                        <input type="button" value="<?php esc_attr_e( 'Remove Image', 'spark-construction-lite' ); ?>" class="button sparkconstructionlite-image-remove" />
                                        <?php
                                        break;
                                    default:
                                        break;
					...
					<div class="clearfix group-footer">
						<a class="group-field-close" href="#close">
							<?php esc_html_e( 'Close', 'spark-construction-lite' ); ?>
						</a>
					</div>
				</div>
			</li>
    ...
    */
    class SparkConstructionLite_Themes_Repeater_Control  extends WP_Customize_Control {
        /**
         * The control type.
         *
         * @access public
		...
		public function enqueue() {
            ...
            wp_enqueue_script('sparkconstructionlite-repeater-control', get_template_directory_uri().'/inc/customizer/js/repeater.js', array( 'jquery', 'customize-controls' ), CONSTRUCTIONLITE_VERSION, true);
            
            // Localize the script with new data
            $translation_array = array(
                'url_to_icon' => esc_url(get_template_directory_uri()) . '/assets/images/icons/',
            );
            wp_localize_script('sparkconstructionlite-repeater-control', 'sparkconstructionlite_script', $translation_array);
		}
        ...
        public function render_content() {
            ...
            <ul class="sparkconstructionlite-repeater-field-control-wrap <?php if( !empty( $this->sortable ) && $this->sortable == 'enable' ){ echo esc_attr( 'sparkconstructionlite-fields-sortable-disable' ); }else{ echo esc_attr( 'sparkconstructionlite-fields-sortable' ); } ?>">
                <?php $this->get_fields(); ?>
            </ul>

            <input type="hidden" <?php esc_attr($this->link()); ?> class="sparkconstructionlite-repeater-collector" value="<?php echo esc_attr($this->value()); ?>" />
            <button type="button" class="button sparkconstructionlite-add-control-field <?php if( $this->limit == $array_lenght) echo esc_attr('hidden'); ?>"><?php echo esc_html($this->add_label); ?></button>
            
            <?php if( $this->limit ): ?>
                <div class="moreitems"><?php echo esc_html('Need More Than','spark-construction-lite'); ?> <span class="upper-limit"><?php echo intval($this->limit); ?> <?php echo esc_html('Items','spark-construction-lite'); ?></span> <a href="<?php echo apply_filters('sparkconstructionlite-link', esc_url('https://ikreatethemes.com/wordpress-theme/construction-wordpress-theme/') );?>" target="_blank"> <strong><?php echo esc_html__('UPGRADE TO PRO', 'spark-construction-lite'); ?></strong></a></div>
                <input type="hidden" class="sparkconstructionlite-repeater-count-limit" value="<?php echo esc_attr($this->limit); ?>" />
            <?php endif; ?>
        ...
        private function get_fields() {
            ...
            if (is_array($values)) {
                ...
                foreach ($values as $value) { ?>
                    <li class="sparkconstructionlite-repeater-field-control">
                        <h3 class="sparkconstructionlite-repeater-field-title"><?php echo esc_html($this->box_label); ?></h3>
                        <div class="sparkconstructionlite-repeater-fields">
                            <?php
                            foreach ($fields as $key => $field) {
                                $class = isset($field['class']) ? $field['class'] : '';
                            ?>
                                <div class="sparkconstructionlite-fields sparkconstructionlite-type-<?php echo esc_attr($field['type']) . ' ' . esc_attr($class); ?>">
                                    <?php
                                        $label = isset($field['label']) ? $field['label'] : '';
                                        $description = isset($field['description']) ? $field['description'] : '';
                                    ...
                                    switch ($field['type']) {
                                        ...
                                        case 'upload':
                                            ...
                                            echo '<div class="sparkconstructionlite-fields-wrap">';
                                            echo '<div class="attachment-media-view">';
                                            echo '<div class="placeholder' . esc_attr($image_class) . '">';
                                                esc_html_e('No image selected', 'spark-construction-lite');
                                            echo '</div>';
                                            echo '<div class="thumbnail thumbnail-image">';
                                            echo $image;
                                            echo '</div>';
                                            echo '<div class="actions clearfix">';
                                            echo '<button type="button" class="button sparkconstructionlite-delete-button align-left">' . esc_html__('Remove', 'spark-construction-lite') . '</button>';
                                            echo '<button type="button" class="button sparkconstructionlite-upload-button alignright">' . esc_html__('Select Image', 'spark-construction-lite') . '</button>';
                                        ...
                                        case 'category':
                                            ...
                                            echo '<option value="0">' . esc_html__('Select Category', 'spark-construction-lite') . '</option>';
                                            echo '<option value="-1">' . esc_html__('Latest Posts', 'spark-construction-lite') . '</option>';
                                        ...
                                        case 'checkbox':
                                            ...
                                            break;
                                        case 'colorpicker':
                                            echo '<input data-default="' . esc_attr($default) . '" class="sparkconstructionlite-color-picker color-picker" data-alpha-enabled="true" data-name="' . esc_attr($key) . '" type="text" value="' . esc_attr($new_value) . '"/>';
                                            break;
                                        case 'selector':
                                            $options = $field['options'];
                                        ...
                                        case 'range':
                                            ...
                                            echo '<div class="sparkconstructionlite-range-slider" >';
                                            ...
                                            break;
                                        case 'icon':
                                            echo '<div class="sparkconstructionlite-customizer-icon-box">';
                                            echo '<div class="sparkconstructionlite-selected-icon">';
                                            echo '<i class="' . esc_attr($new_value) . '"></i>';
                                            echo '<span><i class="dashicons dashicons-arrow-down-alt2"></i></span>';
                                            echo '</div>';
                                            echo '<div class="sparkconstructionlite-icon-box">';
                                                echo '<div class="sparkconstructionlite-icon-search">';
                                                    echo '<select>';
                                                    if (apply_filters('sparkconstructionlite_show_font_awesome', true)) {
                                                        echo '<option value="fontawesome-list">' . esc_html__('Font Awesome', 'spark-construction-lite') . '</option>';
                                                    }
                                                    if (apply_filters('sparkconstructionlite_show_ico_font', true)) {
                                                        echo '<option value="icofont-list">' . esc_html__('IcoFont', 'spark-construction-lite') . '</option>';
                                                    }
                                                    echo '</select>';
                                                    echo '<input type="text" class="sparkconstructionlite-icon-search-input" placeholder="' . esc_attr__('Type to filter', 'spark-construction-lite') . '" />';
                                                echo '</div>';

                                                if (apply_filters('sparkconstructionlite_show_font_awesome', true)) {
                                                    echo '<ul class="sparkconstructionlite-icon-list fontawesome-list active clearfix">';
                                                    $sparkconstructionlite_font_awesome_icon_array = sparkconstructionlite_font_awesome_icon_array();
                                                    foreach ($sparkconstructionlite_font_awesome_icon_array as $sparkconstructionlite_font_awesome_icon) {
                                                        $icon_class = $new_value == $sparkconstructionlite_font_awesome_icon ? 'icon-active' : '';
                                                        echo '<li class=' . esc_attr($icon_class) . '><i class="' . esc_attr($sparkconstructionlite_font_awesome_icon) . '"></i></li>';
                                                    }
                                                    echo '</ul>';
                                                }
                                                ...
                                                if (apply_filters('sparkconstructionlite_show_ico_font', true)) {
                                                    echo '<ul class="sparkconstructionlite-icon-list icofont-list clearfix">';
                                                    $sparkconstructionlite_icofont_icon_array = sparkconstructionlite_icofont_icon_array();
                                                    foreach ($sparkconstructionlite_icofont_icon_array as $sparkconstructionlite_icofont_icon) {
                                                        $icon_class = $new_value == $sparkconstructionlite_icofont_icon ? 'icon-active' : '';
                                                        echo '<li class=' . esc_attr($icon_class) . '><i class="' . esc_attr($sparkconstructionlite_icofont_icon) . '"></i></li>';
                                                    }
                                                    echo '</ul>';
                                                }
                                            echo '</div>';
                                        ...
                                        case 'social-icon':
                                            ...
                                            echo '<div class="sparkconstructionlite-icon-box">';
                                                ...
                                                echo '<ul class="sparkconstructionlite-icon-list fontawesome-list active clearfix">';
                                                $font_awesome_icon_array = sparkconstructionlite_font_awesome_social_icon_array();
                                        ...
                                        case 'multicategory':
                                            ...
                                            echo '<ul class="sparkconstructionlite-multi-category-list">';
                                            echo '<li><label><input type="checkbox" value="-1" ' . checked('-1', $new_value, false) . '/>' . esc_html__('Latest Posts', 'spark-construction-lite') . '</label></li>';
                                            foreach ($this->cats as $cat) {
                                            ...
                                            break;
                                        case 'gallery':?>
                                            <div class="sparkconstructionlite-gallery-screenshot">
                                                <?php
                                                    {
                                            ...
                                            <input id="edit-gallery" class="button upload_gallery_button" type="button" value="<?php esc_attr_e('Add/Edit Gallery','spark-construction-lite') ?>" />
                                            <input id="clear-gallery" class="button upload_gallery_button" type="button" value="<?php esc_attr_e('Clear','spark-construction-lite') ?>" />
                            ...
                            <div class="clearfix sparkconstructionlite-repeater-footer">
                                <div class="alignright">
                                    <a class="sparkconstructionlite-repeater-field-remove" href="#remove"><?php esc_html_e('Delete', 'spark-construction-lite') ?></a> |
                                    <a class="sparkconstructionlite-repeater-field-close" href="#close"><?php esc_html_e('Close', 'spark-construction-lite') ?></a>
                                </div>
                            </div>
                        </div>
                    </li>
    ...
    class SparkConstructionLite_Themes_Upgrade_Text extends WP_Customize_Control {

        public $type = 'sparkconstructionlite-upgrade-text';
        ...
        public function render_content() { ?>
            <label>
                ...
                <?php } ?>
                <a href="<?php echo apply_filters('sparkconstructionlite-link', esc_url('https://ikreatethemes.com/wordpress-theme/construction-wordpress-theme/') ); ?>" target="_blank"> <strong><?php echo esc_html__('UPGRADE TO PRO', 'spark-construction-lite'); ?></strong></a>
            </label>
            <?php if ($this->description) { ?>
                <span class="description customize-control-description">
                    <?php echo wp_kses_post($this->description); ?>
    ...
    class SparkConstructionLite_Themes_Upgrade_Section extends WP_Customize_Section {
         ...
         * @var    string
         */
        public $type = 'sparkconstructionlite-upgrade-section';
        public $class = '';
    ...
    class SparkConstructionLite_Themes_Customize_Section extends WP_Customize_Section {
        /**
         * The type of customize section being rendered.
         *
         * @since  1.1.0
         ...
         * @var    string
         */
        public $type = 'sparkconstructionlite';
