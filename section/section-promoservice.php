...
if (! function_exists( 'sparkconstructionlite_themes_promo_service' ) ):

    function sparkconstructionlite_themes_promo_service(){

        $features_options = get_theme_mod('sparkconstructionlite_promoservice_disable','enable');
        
        $style = get_theme_mod('sparkconstructionlite_promoservice_style', 'style1');
                ...
                <div class="section-wrap">
                    <div class="container">
                        <div class="inner-section-wrap">
                            <?php 
                                $supertitle  = get_theme_mod( 'sparkconstructionlite_promoservice_super_title');
                                $title 		 = get_theme_mod('sparkconstructionlite_promoservice_title');
                                $titlestyle  = get_theme_mod( 'sparkconstructionlite_promoservice_title_align','text-center' );
                                $designstyle = get_theme_mod('sparkconstructionlite_promoservice_title_style','style1');
                            ...
                            <div class="feature-service-wrapper d-grid d-grid-column-3">
                                <?php
                                    $promoservice_type = get_theme_mod('sparkconstructionlite_promoservice_type','default');
                                    
                                    switch ( $promoservice_type ) {
                                        case 'advance':
                                            sparkconstructionlite_themes_promo_advance_sections();
                                            break;
                                        default:
                                            sparkconstructionlite_themes_promo_default_sections();
                                            break;
                                    }
                                ?>
                            </div>
...
add_action('sparkconstructionlite_themes_action_promo_service', 'sparkconstructionlite_themes_promo_service', 30);


if(!function_exists('sparkconstructionlite_themes_promo_default_sections')):
    function sparkconstructionlite_themes_promo_default_sections(){

        $promo_service  = get_theme_mod('sparkconstructionlite_promoservice');
        $show_image = get_theme_mod('sparkconstructionlite_promoservice_show_image', 'enable');
        ...
        if (!empty($page_id)):
            ...
            $iconstyle = '';
            $layout = get_theme_mod('sparkconstructionlite_promoservice_style', 'style1');
            if( !empty( $layout )  && $layout == 'style1'){
                $icon_margin = get_theme_mod('sparkconstructionlite_promo_service_icon', 0);
                $icon_border_width = get_theme_mod('sparkconstructionlite_promo_service_icon_border', 3);
        ...
        ?>
            <div class="feature-service-wrap <?php echo esc_attr( $page->alignment ); ?><?php if(has_post_thumbnail() ): ?> image-<?php echo esc_attr($show_image); ?><?php endif; ?>" <?php echo $style; // Already escaped above ?>>
                ...
                <div class="feature-service-content">
                    <?php if( get_theme_mod('sparkconstructionlite_promoservice_show_icon', 'enable') == 'enable'): ?>
                    ...
                    <div class="service-button-wrap">
                        <a href="<?php the_permalink(); ?>" class="btn btn-noborder"<?php if(!empty($page->color)) { echo ' style="color:' . esc_attr($page->color) . ';border-color:' . esc_attr($page->color) . ';"'; } ?>>
                            <?php echo esc_html__('Read More', 'spark-construction-lite'); ?>
                        </a>
                    </div>
                </div>
            </div>
...
if( !function_exists('sparkconstructionlite_themes_promo_advance_sections') ):
    function sparkconstructionlite_themes_promo_advance_sections(){
        
        $promo_service  = get_theme_mod('sparkconstructionlite_promoservice_advance_settings');
        $show_image = get_theme_mod('sparkconstructionlite_promoservice_show_image', 'enable');
        ...
        foreach ($pages as $page):
            if (!empty($page->block_title)):
                ...
                if( !empty( $layout )  && $layout == 'style1'){
                    $icon_margin = get_theme_mod('sparkconstructionlite_promo_service_icon', 0);
                    $icon_border_width = get_theme_mod('sparkconstructionlite_promo_service_icon_border', 3); // Get border width from theme mod
...
do_action('sparkconstructionlite_themes_action_promo_service');