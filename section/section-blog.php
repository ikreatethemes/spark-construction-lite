...
if (! function_exists( 'sparkconstructionlite_themes_blog' ) ):

    function sparkconstructionlite_themes_blog(){
        
        $blog_options = get_theme_mod('sparkconstructionlite_blog_disable','enable');
            ...
            <div class="section-wrap">
                <div class="container">
                    <div class="inner-section-wrap">
                        <?php 
                            $supertitle = get_theme_mod( 'sparkconstructionlite_blog_super_title' );
                            $title 		= get_theme_mod( 'sparkconstructionlite_blog_title' );
                            $titlestyle  = get_theme_mod('sparkconstructionlite_blog_title_align', 'text-center');
                            $designstyle = get_theme_mod('sparkconstructionlite_blog_title_style','style1');

                            sparkconstructionlite_themes_section_title( $supertitle, $title, $titlestyle, $designstyle ); 

                        $displaystyle = get_theme_mod('sparkconstructionlite_blog_display_style', 'grid');
                        ...
                        <?php  }
                                ...
                                $blog = get_theme_mod('sparkconstructionlite_blog_categories');
                                $cat_id = explode(',', $blog);
                                $post_num = get_theme_mod('sparkconstructionlite_posts_num', 6);
                                $args = array(
...
add_action('sparkconstructionlite_themes_action_blog', 'sparkconstructionlite_themes_blog', 65);


do_action('sparkconstructionlite_themes_action_blog');