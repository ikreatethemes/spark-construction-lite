...
if (! function_exists( 'sparkconstructionlite_themes_video_calltoaction_section' ) ):

    function sparkconstructionlite_themes_video_calltoaction_section(){

        $video_cta_options = get_theme_mod('sparkconstructionlite_videcta_disable','enable');
            ...
            <div class="section-wrap">
                <div class="container">
                    <div class="inner-section-wrap">
                        <?php 
                            $youtube_video_url  = get_theme_mod('sparkconstructionlite_video_button_url','https://www.youtube.com/watch?v=1IaZy0sDLu0');
                            if( $youtube_video_url ){
                            
                            $videoimg = get_theme_mod('sparkconstructionlite_video_calltoaction_video_bg', get_template_directory_uri() . '/assets/images/bg.jpg');
                            $withimage = '';
                            if( empty($videoimg) ){
                                $withimage = 'withoutimage';
                            }
                            $appointment_shortcode = get_theme_mod('sparkconstructionlite_appointment_shortcode');
                            $reverse = get_theme_mod('sparkconstructionlite_video_cta_layout', 'video-cta-top');
                            $class = '';
                            ...
                            <div class="<?php echo esc_attr( $class ); ?>">
                                ...
                                <?php if( $appointment_shortcode ): ?>
                                    <div class="video-call-to-action-content-wrap contact-form">
                                        <?php 
                                            $title = get_theme_mod('sparkconstructionlite_appointment_contact_title','Get in Touch Quickly');
                                            if( !empty( $title ) ){ 
                                        ?>
...
add_action('sparkconstructionlite_themes_video_calltoaction', 'sparkconstructionlite_themes_video_calltoaction_section', 40);

do_action('sparkconstructionlite_themes_video_calltoaction');