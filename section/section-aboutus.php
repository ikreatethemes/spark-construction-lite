<?php
if( !function_exists('sparkconstructionlite_themes_about_us_image')):
    function sparkconstructionlite_themes_about_us_image( $about_image, $astyle ){ ?>
...
if( !function_exists('sparkconstructionlite_themes_about_us_content')):

    function sparkconstructionlite_themes_about_us_content( $astyle ){

        $super_title = get_theme_mod('sparkconstructionlite_aboutus_super_title'); ?>
            <div class="about-right">
                ...
                <div class="section-tagline-text">
                    ...
                    if (get_theme_mod('sparkconstructionlite_progress', 'disable') == 'enable'):
                        $about_progressitem = get_theme_mod('sparkconstructionlite_progressbar_item');
                    ...
                    ?>
                        <div class="sparkconstructionlite-progress-bar-wrapper">
                            <div class="sparkconstructionlite-progress-item">
                                <span class="sparkconstructionlite-progress-title"><?php echo esc_html( $progressitem->progressbar_title ); ?></span>
                                <div class="sparkconstructionlite-progress-bar" data-width="<?php echo esc_attr( $progressitem->progressbar_number ); ?>">
                                    <div class="sparkconstructionlite-progress-bar-length" style="background-color:<?php echo esc_attr( $progressitem->progressbar_color ); ?>">
                    ...
                    <?php 
                        ...
                        $image = get_theme_mod('sparkconstructionlite_aboutus_profile_image');
                        $profile_name = get_theme_mod('sparkconstructionlite_aboutus_profile_name');
                            ...
                            <div class="about-profile">
                                ...
                                <?php if( $profile_name ): ?>
                                    <div class="profile-info">
                                        ...
                                        <?php if($profile_role = get_theme_mod('sparkconstructionlite_aboutus_profile_role') ): ?>
...
if (! function_exists( 'sparkconstructionlite_themes_about' ) ):
    
    function sparkconstructionlite_themes_about(){ 

        $aboutus_options = get_theme_mod('sparkconstructionlite_aboutus_disable','enable');

        if( !empty( $aboutus_options ) && $aboutus_options == 'enable' ){

            $astyle = get_theme_mod('sparkconstructionlite_aboutus_layout_design', 'layouttwo');
            $service_class = array(
                $astyle,
                'section',
                'aboutus-section',
                ...
                <div class="section-wrap">
                    <div class="container">
                        <div class="about-wrapper inner-section-wrap">
                            <?php
                                $aboutus = get_theme_mod('sparkconstructionlite_about');
                                if (!empty( $aboutus ) ):
                                $aboutus_args = array(
                                    'posts_per_page' => 1,
                                    'post_type' => 'page',
                                ...
                                $about_image = get_theme_mod('sparkconstructionlite_about_image');
                                
                                sparkconstructionlite_themes_about_us_image( $about_image, $astyle );

                                sparkconstructionlite_themes_about_us_content( $astyle );
                            ?>
...
add_action('sparkconstructionlite_themes_action_about', 'sparkconstructionlite_themes_about', 35);

do_action('sparkconstructionlite_themes_action_about');